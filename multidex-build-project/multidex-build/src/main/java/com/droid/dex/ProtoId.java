...
public final class ProtoId implements Comparable<ProtoId> {
    ...
    public int compareTo(ProtoId other) {
        if (returnTypeIndex != other.returnTypeIndex) {
            return com.droid.dex.util.Unsigned.compare(returnTypeIndex, other.returnTypeIndex);
        }
        return com.droid.dex.util.Unsigned.compare(parametersOffset, other.parametersOffset);
    }
