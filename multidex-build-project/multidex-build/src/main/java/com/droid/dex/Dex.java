...
import com.droid.dex.Code.CatchHandler;
import com.droid.dex.Code.Try;
import com.droid.dex.util.ByteInput;
import com.droid.dex.util.ByteOutput;
import com.droid.dex.util.FileUtils;
...
public final class Dex {
    ...
    public Dex(File file) throws IOException {
        if (FileUtils.hasArchiveSuffix(file.getName())) {
            ...
            if (entry != null) {
                ...
                throw new com.droid.dex.DexException("Expected " + DexFormat.DEX_IN_JAR_NAME + " in " + file);
            }
        } else if (file.getName().endsWith(".dex")) {
            loadFrom(new FileInputStream(file));
        } else {
            throw new com.droid.dex.DexException("unknown output extension: " + file);
        }
    }
    ...
    public List<com.droid.dex.ProtoId> protoIds() {
        return protoIds;
    }

    public List<com.droid.dex.FieldId> fieldIds() {
        return fieldIds;
    }

    public List<com.droid.dex.MethodId> methodIds() {
        return methodIds;
    }

    public Iterable<com.droid.dex.ClassDef> classDefs() {
        return new ClassDefIterable();
    }

    public com.droid.dex.TypeList readTypeList(int offset) {
        if (offset == 0) {
            return com.droid.dex.TypeList.EMPTY;
        }
        return open(offset).readTypeList();
    }

    public com.droid.dex.ClassData readClassData(com.droid.dex.ClassDef classDef) {
    ...
    public com.droid.dex.Code readCode(com.droid.dex.ClassData.Method method) {
    ...
    public int nameIndexFromFieldIndex(int fieldIndex) {
        ...
        int position = tableOfContents.fieldIds.off + (com.droid.dex.SizeOf.MEMBER_ID_ITEM * fieldIndex);
        position += com.droid.dex.SizeOf.USHORT;  // declaringClassIndex
        position += com.droid.dex.SizeOf.USHORT;  // typeIndex
    ...
    public int findFieldIndex(com.droid.dex.FieldId fieldId) {
        return Collections.binarySearch(fieldIds, fieldId);
    }

    public int findMethodIndex(com.droid.dex.MethodId methodId) {
    ...
    public int declaringClassIndexFromMethodIndex(int methodIndex) {
        ...
        int position = tableOfContents.methodIds.off + (com.droid.dex.SizeOf.MEMBER_ID_ITEM * methodIndex);
    ...
    public int nameIndexFromMethodIndex(int methodIndex) {
        ...
        int position = tableOfContents.methodIds.off + (com.droid.dex.SizeOf.MEMBER_ID_ITEM * methodIndex);
        position += com.droid.dex.SizeOf.USHORT;  // declaringClassIndex
        position += com.droid.dex.SizeOf.USHORT;  // protoIndex
        return data.getInt(position);  // nameIndex
    }
    ...
    public short[] parameterTypeIndicesFromMethodIndex(int methodIndex) {
        ...
        position = tableOfContents.protoIds.off + (com.droid.dex.SizeOf.PROTO_ID_ITEM * protoIndex);
        position += com.droid.dex.SizeOf.UINT;  // shortyIndex
        position += com.droid.dex.SizeOf.UINT;  // returnTypeIndex
        ...
        position += com.droid.dex.SizeOf.UINT;
        short[] types = new short[size];
        for (int i = 0; i < size; i++) {
            types[i] = data.getShort(position);
            position += com.droid.dex.SizeOf.USHORT;
        }
        return types;
    }
    ...
    public int descriptorIndexFromTypeIndex(int typeIndex) {
       checkBounds(typeIndex, tableOfContents.typeIds.size);
       int position = tableOfContents.typeIds.off + (com.droid.dex.SizeOf.TYPE_ID_ITEM * typeIndex);
    ...
    public int typeIndexFromClassDefIndex(int classDefIndex) {
        ...
        int position = tableOfContents.classDefs.off + (com.droid.dex.SizeOf.CLASS_DEF_ITEM * classDefIndex);
        return data.getInt(position);
    }
    ...
    public int annotationDirectoryOffsetFromClassDefIndex(int classDefIndex) {
        checkBounds(classDefIndex, tableOfContents.classDefs.size);
        int position = tableOfContents.classDefs.off + (com.droid.dex.SizeOf.CLASS_DEF_ITEM * classDefIndex);
        position += com.droid.dex.SizeOf.UINT;  // type
        position += com.droid.dex.SizeOf.UINT;  // accessFlags
        position += com.droid.dex.SizeOf.UINT;  // superType
        position += com.droid.dex.SizeOf.UINT;  // interfacesOffset
        position += com.droid.dex.SizeOf.UINT;  // sourceFileIndex
        return data.getInt(position);
    }
    ...
    public final class Section implements ByteInput, ByteOutput {
        ...
        public com.droid.dex.TypeList readTypeList() {
            int size = readInt();
            short[] types = readShortArray(size);
            alignToFourBytes();
            return new com.droid.dex.TypeList(Dex.this, types);
        }
        ...
        public String readString() {
            ...
            try {
                ...
                String result = com.droid.dex.Mutf8.decode(this, new char[expectedLength]);
                if (result.length() != expectedLength) {
                    throw new com.droid.dex.DexException("Declared length " + expectedLength
                            + " doesn't match decoded length of " + result.length());
                }
                return result;
            } catch (UTFDataFormatException e) {
                throw new com.droid.dex.DexException(e);
            } finally {
        ...
        public com.droid.dex.FieldId readFieldId() {
            int declaringClassIndex = readUnsignedShort();
            int typeIndex = readUnsignedShort();
            int nameIndex = readInt();
            return new com.droid.dex.FieldId(Dex.this, declaringClassIndex, typeIndex, nameIndex);
        }

        public com.droid.dex.MethodId readMethodId() {
            int declaringClassIndex = readUnsignedShort();
            int protoIndex = readUnsignedShort();
            int nameIndex = readInt();
            return new com.droid.dex.MethodId(Dex.this, declaringClassIndex, protoIndex, nameIndex);
        }

        public com.droid.dex.ProtoId readProtoId() {
            int shortyIndex = readInt();
            int returnTypeIndex = readInt();
            int parametersOffset = readInt();
            return new com.droid.dex.ProtoId(Dex.this, shortyIndex, returnTypeIndex, parametersOffset);
        }

        public com.droid.dex.ClassDef readClassDef() {
            ...
            return new com.droid.dex.ClassDef(Dex.this, offset, type, accessFlags, supertype,
                    interfacesOffset, sourceFileIndex, annotationsOffset, classDataOffset,
                    staticValuesOffset);
        }

        private com.droid.dex.Code readCode() {
            ...
            if (triesSize > 0) {
                ...
                skip(triesSize * com.droid.dex.SizeOf.TRY_ITEM);
            ...
            return new com.droid.dex.Code(registersSize, insSize, outsSize, debugInfoOffset, instructions,
                            tries, catchHandlers);
        }
        ...
        private com.droid.dex.ClassData readClassData() {
            ...
            com.droid.dex.ClassData.Field[] staticFields = readFields(staticFieldsSize);
            com.droid.dex.ClassData.Field[] instanceFields = readFields(instanceFieldsSize);
            com.droid.dex.ClassData.Method[] directMethods = readMethods(directMethodsSize);
            com.droid.dex.ClassData.Method[] virtualMethods = readMethods(virtualMethodsSize);
            return new com.droid.dex.ClassData(staticFields, instanceFields, directMethods, virtualMethods);
        }

        private com.droid.dex.ClassData.Field[] readFields(int count) {
            com.droid.dex.ClassData.Field[] result = new com.droid.dex.ClassData.Field[count];
            int fieldIndex = 0;
            for (int i = 0; i < count; i++) {
                fieldIndex += readUleb128(); // field index diff
                int accessFlags = readUleb128();
                result[i] = new com.droid.dex.ClassData.Field(fieldIndex, accessFlags);
            }
            return result;
        }

        private com.droid.dex.ClassData.Method[] readMethods(int count) {
            com.droid.dex.ClassData.Method[] result = new com.droid.dex.ClassData.Method[count];
            int methodIndex = 0;
            for (int i = 0; i < count; i++) {
                methodIndex += readUleb128(); // method index diff
                int accessFlags = readUleb128();
                int codeOff = readUleb128();
                result[i] = new com.droid.dex.ClassData.Method(methodIndex, accessFlags, codeOff);
            }
            return result;
        }
        ...
        public Annotation readAnnotation() {
            ...
            new com.droid.dex.EncodedValueReader(this, com.droid.dex.EncodedValueReader.ENCODED_ANNOTATION).skipValue();
            return new Annotation(Dex.this, visibility, new com.droid.dex.EncodedValue(getBytesFrom(start)));
        }

        public com.droid.dex.EncodedValue readEncodedArray() {
            int start = data.position();
            new com.droid.dex.EncodedValueReader(this, com.droid.dex.EncodedValueReader.ENCODED_ARRAY).skipValue();
            return new com.droid.dex.EncodedValue(getBytesFrom(start));
        }
        ...
        public void writeUleb128(int i) {
            try {
                ...
                throw new com.droid.dex.DexException("Section limit " + data.limit() + " exceeded by " + name);
            }
        }
        ...
        public void writeStringData(String value) {
            try {
                ...
                writeUleb128(length);
                write(com.droid.dex.Mutf8.encode(value));
                writeByte(0);
            } catch (UTFDataFormatException e) {
                throw new AssertionError();
            }
        ...
        public void writeTypeList(com.droid.dex.TypeList typeList) {
    ...
    private final class StringTable extends AbstractList<String> implements RandomAccess {
        @Override public String get(int index) {
            ...
            return open(tableOfContents.stringIds.off + (index * com.droid.dex.SizeOf.STRING_ID_ITEM))
                    .readString();
        }
    ...
    private final class ProtoIdTable extends AbstractList<com.droid.dex.ProtoId> implements RandomAccess {
        @Override public com.droid.dex.ProtoId get(int index) {
            checkBounds(index, tableOfContents.protoIds.size);
            return open(tableOfContents.protoIds.off + (com.droid.dex.SizeOf.PROTO_ID_ITEM * index))
                    .readProtoId();
        }
        @Override public int size() {
    ...
    private final class FieldIdTable extends AbstractList<com.droid.dex.FieldId> implements RandomAccess {
        @Override public com.droid.dex.FieldId get(int index) {
            checkBounds(index, tableOfContents.fieldIds.size);
            return open(tableOfContents.fieldIds.off + (com.droid.dex.SizeOf.MEMBER_ID_ITEM * index))
                    .readFieldId();
        }
        @Override public int size() {
    ...
    private final class MethodIdTable extends AbstractList<com.droid.dex.MethodId> implements RandomAccess {
        @Override public com.droid.dex.MethodId get(int index) {
            checkBounds(index, tableOfContents.methodIds.size);
            return open(tableOfContents.methodIds.off + (com.droid.dex.SizeOf.MEMBER_ID_ITEM * index))
                    .readMethodId();
        }
        @Override public int size() {
    ...
    private final class ClassDefIterator implements Iterator<com.droid.dex.ClassDef> {
        ...
        @Override
        public com.droid.dex.ClassDef next() {
            if (!hasNext()) {
    ...
    private final class ClassDefIterable implements Iterable<com.droid.dex.ClassDef> {
        public Iterator<com.droid.dex.ClassDef> iterator() {
            return !tableOfContents.classDefs.exists()
               ? Collections.<com.droid.dex.ClassDef>emptySet().iterator()
