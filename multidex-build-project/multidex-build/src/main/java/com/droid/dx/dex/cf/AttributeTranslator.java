...
import com.droid.dx.dex.file.AnnotationUtils;
...
/*package*/ class AttributeTranslator {
     ...
     * @return {@code non-null;} the set of annotations, which may be empty
     */
    public static Annotations getClassAnnotations(com.droid.dx.cf.direct.DirectClassFile cf,
                                                  CfOptions args) {
        ...
        } catch (com.droid.dx.util.Warning warn) {
        ...
        if (com.droid.dx.rop.code.AccessFlags.isAnnotation(cf.getAccessFlags())) {
    ...
    private static Annotation translateEnclosingMethod(AttributeList attribs) {
        ...
        return AnnotationUtils.makeEnclosingMethod(
                new com.droid.dx.rop.cst.CstMethodRef(enclosingClass, nat));
    }
    ...
    private static Annotations translateInnerClasses(CstType thisClass,
        ...
        if (foundThisClass != null) {
            ...
            if (needEnclosingClass) {
                ...
                if (outer == null) {
                    throw new com.droid.dx.util.Warning(
     ...
     */
    private static Annotation translateAnnotationDefaults(com.droid.dx.cf.direct.DirectClassFile cf) {
        CstType thisClass = cf.getThisClass();
