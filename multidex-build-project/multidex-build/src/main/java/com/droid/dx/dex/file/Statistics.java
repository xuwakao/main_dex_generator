...
public final class Statistics {
     ...
     */
    public void add(com.droid.dx.dex.file.Item item) {
    ...
    public void addAll(Section list) {
        Collection<? extends com.droid.dx.dex.file.Item> items = list.items();
        for (com.droid.dx.dex.file.Item item : items) {
            add(item);
        }
    }
    ...
    private static class Data {
         ...
         */
        public Data(com.droid.dx.dex.file.Item item, String name) {
