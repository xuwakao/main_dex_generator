...
public class ConstCollector {
    ...
    private ArrayList<TypedConstant> getConstsSortedByCountUse() {
        ...
        for (int i = 0; i < regSz; i++) {
            com.droid.dx.ssa.SsaInsn insn = ssaMeth.getDefinitionForRegister(i);
    ...
    private void fixLocalAssignment(RegisterSpec origReg,
            RegisterSpec newReg) {
        for (com.droid.dx.ssa.SsaInsn use : ssaMeth.getUseListForRegister(origReg.getReg())) {
            ...
            com.droid.dx.rop.code.LocalItem local = localAssignment.getLocalItem();
            ...
            ArrayList<com.droid.dx.ssa.SsaInsn> insns = use.getBlock().getInsns();
    ...
    private void updateConstUses(HashMap<TypedConstant, RegisterSpec> newRegs,
        ...
        final ArrayList<com.droid.dx.ssa.SsaInsn>[] useList = ssaMeth.getUseListCopy();
        ...
        for (int i = 0; i < origRegCount; i++) {
            ...
            com.droid.dx.ssa.RegisterMapper mapper = new com.droid.dx.ssa.RegisterMapper() {
                @Override
            ...
            for (com.droid.dx.ssa.SsaInsn use : useList[origReg.getReg()]) {
                if (use.canThrow()
