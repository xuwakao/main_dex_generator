...
public final class CstEnumRef extends CstMemberRef {
    ...
    private com.droid.dx.rop.cst.CstFieldRef fieldRef;
    ...
    /**
     * Get a {@link com.droid.dx.rop.cst.CstFieldRef} that corresponds with this instance.
     *
     * @return {@code non-null;} the corresponding field reference
     */
    public com.droid.dx.rop.cst.CstFieldRef getFieldRef() {
        if (fieldRef == null) {
            fieldRef = new com.droid.dx.rop.cst.CstFieldRef(getDefiningClass(), getNat());
        }
