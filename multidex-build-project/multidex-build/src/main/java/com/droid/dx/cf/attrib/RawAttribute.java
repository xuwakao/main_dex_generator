...
package com.droid.dx.cf.attrib;
...
public final class RawAttribute extends BaseAttribute {
    ...
    private final com.droid.dx.util.ByteArray data;
     ...
     */
    public RawAttribute(String name, com.droid.dx.util.ByteArray data, ConstantPool pool) {
        super(name);
    ...
    /**
     * Constructs an instance from a sub-array of a {@link com.droid.dx.util.ByteArray}.
     *
     * @param name {@code non-null;} attribute name
     ...
     * @param pool {@code null-ok;} constant pool to use for cpi resolution
     */
    public RawAttribute(String name, com.droid.dx.util.ByteArray data, int offset,
     ...
     */
    public com.droid.dx.util.ByteArray getData() {
        return data;
    }
