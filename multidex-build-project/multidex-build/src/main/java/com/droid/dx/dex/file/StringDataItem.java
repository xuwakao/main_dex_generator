 ...
 */
public final class StringDataItem extends com.droid.dx.dex.file.OffsettedItem {
    /** {@code non-null;} the string value */
    private final com.droid.dx.rop.cst.CstString value;
     ...
     */
    public StringDataItem(com.droid.dx.rop.cst.CstString value) {
     ...
     */
    private static int writeSize(com.droid.dx.rop.cst.CstString value) {
        int utf16Size = value.getUtf16Size();

        // The +1 is for the '\0' termination byte.
        return com.droid.dex.Leb128.unsignedLeb128Size(utf16Size)
            + value.getUtf8Size() + 1;
    }
    ...
    public void writeTo0(DexFile file, AnnotatedOutput out) {
        ...
        if (out.annotates()) {
            out.annotate(com.droid.dex.Leb128.unsignedLeb128Size(utf16Size),
