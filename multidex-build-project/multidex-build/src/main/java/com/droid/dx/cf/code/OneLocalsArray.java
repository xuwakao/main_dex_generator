 ...
 * com.droid.dx.rop.type.TypeBearer}.</p>
 */
public class OneLocalsArray extends LocalsArray {
    /** {@code non-null;} actual array */
    private final com.droid.dx.rop.type.TypeBearer[] locals;
    ...
    public OneLocalsArray(int maxLocals) {
        super(maxLocals != 0);
        locals = new com.droid.dx.rop.type.TypeBearer[maxLocals];
    }
    ...
    /** @inheritDoc */
    public void annotate(com.droid.dex.util.ExceptionWithContext ex) {
        for (int i = 0; i < locals.length; i++) {
            com.droid.dx.rop.type.TypeBearer type = locals[i];
            String s = (type == null) ? "<invalid>" : type.toString();
            ex.addContext("locals[" + com.droid.dx.util.Hex.u2(i) + "]: " + s);
        }
    }
    ...
    public String toHuman() {
        ...
        for (int i = 0; i < locals.length; i++) {
            com.droid.dx.rop.type.TypeBearer type = locals[i];
            String s = (type == null) ? "<invalid>" : type.toString();
            sb.append("locals[" + com.droid.dx.util.Hex.u2(i) + "]: " + s + "\n");
        }
    ...
    /** @inheritDoc */
    public void makeInitialized(com.droid.dx.rop.type.Type type) {
        ...
        com.droid.dx.rop.type.Type initializedType = type.getInitializedType();
    ...
    /** @inheritDoc */
    public void set(int idx, com.droid.dx.rop.type.TypeBearer type) {
        throwIfImmutable();
        ...
        if (idx != 0) {
            com.droid.dx.rop.type.TypeBearer prev = locals[idx - 1];
    ...
    /** @inheritDoc */
    public void set(com.droid.dx.rop.code.RegisterSpec spec) {
    ...
    /** @inheritDoc */
    public com.droid.dx.rop.type.TypeBearer getOrNull(int idx) {
        return locals[idx];
    }

    /** @inheritDoc */
    public com.droid.dx.rop.type.TypeBearer get(int idx) {
        com.droid.dx.rop.type.TypeBearer result = locals[idx];
    ...
    /** @inheritDoc */
    public com.droid.dx.rop.type.TypeBearer getCategory1(int idx) {
        com.droid.dx.rop.type.TypeBearer result = get(idx);
        com.droid.dx.rop.type.Type type = result.getType();
    ...
    /** @inheritDoc */
    public com.droid.dx.rop.type.TypeBearer getCategory2(int idx) {
        com.droid.dx.rop.type.TypeBearer result = get(idx);
     ...
     */
    private static com.droid.dx.rop.type.TypeBearer throwSimException(int idx, String msg) {
        throw new SimException("local " + com.droid.dx.util.Hex.u2(idx) + ": " + msg);
    }
}
