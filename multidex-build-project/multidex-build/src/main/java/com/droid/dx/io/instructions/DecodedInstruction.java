...
public abstract class DecodedInstruction {
    ...
    private final com.droid.dx.io.instructions.InstructionCodec format;
    ...
    public static DecodedInstruction decode(CodeInput in) throws EOFException {
        ...
        com.droid.dx.io.instructions.InstructionCodec format = com.droid.dx.io.OpcodeInfo.getFormat(opcode);
     ...
     */
    public DecodedInstruction(com.droid.dx.io.instructions.InstructionCodec format, int opcode,
    ...
    public final com.droid.dx.io.instructions.InstructionCodec getFormat() {
        return format;
    }
     ...
     */
    public final void encode(com.droid.dx.io.instructions.CodeOutput out) {
