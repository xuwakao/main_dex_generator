...
package com.droid.dx.io.instructions;

import com.droid.dex.DexException;
import com.droid.dx.io.IndexType;
...
public enum InstructionCodec {
    FORMAT_00X() {
        @Override public DecodedInstruction decode(int opcodeUnit,
            ...
            return new com.droid.dx.io.instructions.ZeroRegisterDecodedInstruction(
                    this, opcodeUnit, 0, null,
                    0, 0L);
        }

        @Override public void encode(DecodedInstruction insn, com.droid.dx.io.instructions.CodeOutput out) {
    ...
    FORMAT_12X() {
        @Override public DecodedInstruction decode(int opcodeUnit,
            ...
            return new com.droid.dx.io.instructions.TwoRegisterDecodedInstruction(
                    this, opcode, 0, null,
                    0, 0L,
                    a, b);
        }
    ...
    FORMAT_11N() {
        @Override public DecodedInstruction decode(int opcodeUnit,
            ...
            return new com.droid.dx.io.instructions.OneRegisterDecodedInstruction(
                    this, opcode, 0, null,
                    0, literal,
                    a);
        }
    ...
    FORMAT_21C() {
        @Override public DecodedInstruction decode(int opcodeUnit,
            ...
            int a = byte1(opcodeUnit);
            int index = in.read();
            IndexType indexType = com.droid.dx.io.OpcodeInfo.getIndexType(opcode);
            return new com.droid.dx.io.instructions.OneRegisterDecodedInstruction(
    ...
    FORMAT_23X() {
        @Override public DecodedInstruction decode(int opcodeUnit,
            ...
            int b = byte0(bc);
            int c = byte1(bc);
            return new com.droid.dx.io.instructions.ThreeRegisterDecodedInstruction(
                    this, opcode, 0, null,
                    0, 0L,
                    a, b, c);
        }
    ...
    FORMAT_FILL_ARRAY_DATA_PAYLOAD() {
        @Override public DecodedInstruction decode(int opcodeUnit,
            ...
            switch (elementWidth) {
                case 1: {
                    ...
                    return new com.droid.dx.io.instructions.FillArrayDataPayloadDecodedInstruction(
        ...
        @Override public void encode(DecodedInstruction insn, com.droid.dx.io.instructions.CodeOutput out) {
            com.droid.dx.io.instructions.FillArrayDataPayloadDecodedInstruction payload =
                (com.droid.dx.io.instructions.FillArrayDataPayloadDecodedInstruction) insn;
     ...
     */
    public abstract void encode(DecodedInstruction insn, com.droid.dx.io.instructions.CodeOutput out);
        ...
        switch (registerCount) {
            ...
            case 3:
                return new com.droid.dx.io.instructions.ThreeRegisterDecodedInstruction(
                        ...
                        a, b, c);
            case 4:
                return new com.droid.dx.io.instructions.FourRegisterDecodedInstruction(
                        format, opcode, index, indexType,
                        0, 0L,
                        a, b, c, d);
            case 5:
                return new com.droid.dx.io.instructions.FiveRegisterDecodedInstruction(
                        format, opcode, index, indexType,
                        0, 0L,
                        a, b, c, d, e);
        }
    ...
    private static void encodeRegisterList(DecodedInstruction insn,
            com.droid.dx.io.instructions.CodeOutput out) {
    ...
    private static DecodedInstruction decodeRegisterRange(
        ...
        int a = in.read();
        IndexType indexType = com.droid.dx.io.OpcodeInfo.getIndexType(opcode);
        return new com.droid.dx.io.instructions.RegisterRangeDecodedInstruction(
                format, opcode, index, indexType,
                0, 0L,
                a, registerCount);
    }
