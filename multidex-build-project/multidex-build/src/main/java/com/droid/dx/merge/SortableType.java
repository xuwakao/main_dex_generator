...
final class SortableType {
    ...
    private com.droid.dex.ClassDef classDef;
    private int depth = -1;

    public SortableType(com.droid.dex.Dex dex, IndexMap indexMap, com.droid.dex.ClassDef classDef) {
        this.dex = dex;
        this.indexMap = indexMap;
        this.classDef = classDef;
    }

    public com.droid.dex.Dex getDex() {
        return dex;
    }
    ...
    public com.droid.dex.ClassDef getClassDef() {
        return classDef;
    }
    ...
    public boolean tryAssignDepth(SortableType[] types) {
        int max;
        if (classDef.getSupertypeIndex() == com.droid.dex.ClassDef.NO_INDEX) {
