...
public final class AnnotationsDirectoryItem extends OffsettedItem {
     ...
     */
    public void setClassAnnotations(com.droid.dx.rop.annotation.Annotations annotations, DexFile dexFile) {
        if (annotations == null) {
     ...
     * @param dexFile {@code non-null;} dex output
     */
    public void addFieldAnnotations(com.droid.dx.rop.cst.CstFieldRef field,
                                    com.droid.dx.rop.annotation.Annotations annotations, DexFile dexFile) {
    ...
    public void addParameterAnnotations(com.droid.dx.rop.cst.CstMethodRef method,
                                        com.droid.dx.rop.annotation.AnnotationsList list, DexFile dexFile) {
     ...
     */
    public com.droid.dx.rop.annotation.Annotations getMethodAnnotations(com.droid.dx.rop.cst.CstMethodRef method) {
        if (methodAnnotations == null) {
            return null;
        }
    ...
    /** {@inheritDoc} */
    @Override
    protected void writeTo0(DexFile file, com.droid.dx.util.AnnotatedOutput out) {
