...
public final class LocalList extends FixedSizeList {
    ...
    public static class Entry implements Comparable<Entry> {
         ...
         */
        public com.droid.dx.rop.cst.CstString getSignature() {
    ...
    public static LocalList make(DalvInsnList insns) {
        ...
        for (int i = 0; i < sz; i++) {
            ...
            if (insn instanceof com.droid.dx.dex.code.LocalSnapshot) {
                RegisterSpecSet snapshot =
                    ((com.droid.dx.dex.code.LocalSnapshot) insn).getLocals();
                state.snapshot(insn.getAddress(), snapshot);
            } else if (insn instanceof com.droid.dx.dex.code.LocalStart) {
                RegisterSpec local = ((com.droid.dx.dex.code.LocalStart) insn).getLocal();
