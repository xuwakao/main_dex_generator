...
public abstract class MemberIdItem extends IdItem {
    ...
    private final com.droid.dx.rop.cst.CstMemberRef cst;
     ...
     */
    public MemberIdItem(com.droid.dx.rop.cst.CstMemberRef cst) {
    ...
    public int writeSize() {
        return com.droid.dex.SizeOf.MEMBER_ID_ITEM;
    }
    ...
    /** {@inheritDoc} */
    @Override
    public final void writeTo(DexFile file, com.droid.dx.util.AnnotatedOutput out) {
        TypeIdsSection typeIds = file.getTypeIds();
        StringIdsSection stringIds = file.getStringIds();
        com.droid.dx.rop.cst.CstNat nat = cst.getNat();
     ...
     */
    public final com.droid.dx.rop.cst.CstMemberRef getRef() {
        return cst;
    }
}
