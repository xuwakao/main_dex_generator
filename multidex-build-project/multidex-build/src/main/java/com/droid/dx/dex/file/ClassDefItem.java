...
import com.droid.dx.rop.cst.CstArray;
...
public final class ClassDefItem extends IndexedItem {
    ...
    private com.droid.dx.dex.file.TypeListItem interfaces;

    /** {@code null-ok;} source file name or {@code null} if unknown */
    private final com.droid.dx.rop.cst.CstString sourceFile;

    /** {@code non-null;} associated class data object */
    private final com.droid.dx.dex.file.ClassDataItem classData;
    ...
    private com.droid.dx.dex.file.AnnotationsDirectoryItem annotationsDirectory;
    ...
    public ClassDefItem(CstType thisClass, int accessFlags,
                        CstType superclass, com.droid.dx.rop.type.TypeList interfaces, com.droid.dx.rop.cst.CstString sourceFile) {
        if (thisClass == null) {
        ...
        this.interfaces =
            (interfaces.size() == 0) ? null :  new com.droid.dx.dex.file.TypeListItem(interfaces);
        this.sourceFile = sourceFile;
        this.classData = new com.droid.dx.dex.file.ClassDataItem(thisClass);
        this.staticValuesItem = null;
        this.annotationsDirectory = new com.droid.dx.dex.file.AnnotationsDirectoryItem();
    }
    ...
    public void addContents(com.droid.dx.dex.file.DexFile file) {
        com.droid.dx.dex.file.TypeIdsSection typeIds = file.getTypeIds();
        com.droid.dx.dex.file.MixedItemSection byteData = file.getByteData();
        com.droid.dx.dex.file.MixedItemSection wordData = file.getWordData();
        com.droid.dx.dex.file.MixedItemSection typeLists = file.getTypeLists();
        com.droid.dx.dex.file.StringIdsSection stringIds = file.getStringIds();

        typeIds.intern(thisClass);

        if (!classData.isEmpty()) {
            com.droid.dx.dex.file.MixedItemSection classDataSection = file.getClassData();
    ...
    public void writeTo(com.droid.dx.dex.file.DexFile file, AnnotatedOutput out) {
        ...
        int interOff = com.droid.dx.dex.file.OffsettedItem.getAbsoluteOffsetOr0(interfaces);
     ...
     */
    public com.droid.dx.rop.type.TypeList getInterfaces() {
        if (interfaces == null) {
     ...
     */
    public com.droid.dx.rop.cst.CstString getSourceFile() {
        return sourceFile;
    }
     ...
     */
    public void addStaticField(com.droid.dx.dex.file.EncodedField field, Constant value) {
     ...
     * @param field {@code non-null;} the field to add
     */
    public void addInstanceField(com.droid.dx.dex.file.EncodedField field) {
     ...
     */
    public void addDirectMethod(com.droid.dx.dex.file.EncodedMethod method) {
     ...
     * @param method {@code non-null;} the method to add
     */
    public void addVirtualMethod(com.droid.dx.dex.file.EncodedMethod method) {
     ...
     */
    public ArrayList<com.droid.dx.dex.file.EncodedMethod> getMethods() {
     ...
     */
    public void setClassAnnotations(Annotations annotations, com.droid.dx.dex.file.DexFile dexFile) {
    ...
    public void addFieldAnnotations(CstFieldRef field,
            Annotations annotations, com.droid.dx.dex.file.DexFile dexFile) {
     ...
     * @param dexFile {@code non-null;} dex output
     */
    public void addMethodAnnotations(com.droid.dx.rop.cst.CstMethodRef method,
                                     Annotations annotations, com.droid.dx.dex.file.DexFile dexFile) {
     ...
     * @param dexFile {@code non-null;} dex output
     */
    public void addParameterAnnotations(com.droid.dx.rop.cst.CstMethodRef method,
                                        com.droid.dx.rop.annotation.AnnotationsList list, com.droid.dx.dex.file.DexFile dexFile) {
     ...
     */
    public Annotations getMethodAnnotations(com.droid.dx.rop.cst.CstMethodRef method) {
     ...
     */
    public com.droid.dx.rop.annotation.AnnotationsList getParameterAnnotations(com.droid.dx.rop.cst.CstMethodRef method) {
    ...
    public void debugPrint(Writer out, boolean verbose) {
        PrintWriter pw = com.droid.dx.util.Writers.printWriterFor(out);
