...
import com.droid.dx.ssa.PhiInsn;
import com.droid.dx.ssa.RegisterMapper;
import com.droid.dx.ssa.SsaInsn;
...
public class SsaToRop {
    ...
    private final com.droid.dx.ssa.SsaMethod ssaMeth;
     ...
     */
    public static com.droid.dx.rop.code.RopMethod convertToRopMethod(com.droid.dx.ssa.SsaMethod ssaMeth,
     ...
     * attempt to minimize the rop-form register count
     */
    private SsaToRop(com.droid.dx.ssa.SsaMethod ssaMethod, boolean minimizeRegisters) {
     ...
     * @return {@code non-null;} rop-form output
     */
    private com.droid.dx.rop.code.RopMethod convert() {
        if (DEBUG) {
        ...
        RegisterAllocator allocator =
            new com.droid.dx.ssa.back.FirstFitLocalCombiningAllocator(ssaMeth, interference,
                    minimizeRegisters);
        ...
        if (DEBUG) {
            ...
            System.out.println(((com.droid.dx.ssa.BasicRegisterMapper)mapper).toHuman());
        }
        ...
        com.droid.dx.rop.code.RopMethod ropMethod = new com.droid.dx.rop.code.RopMethod(convertBasicBlocks(),
    ...
    private void removeEmptyGotos() {
        final ArrayList<com.droid.dx.ssa.SsaBasicBlock> blocks = ssaMeth.getBlocks();

        ssaMeth.forEachBlockDepthFirst(false, new com.droid.dx.ssa.SsaBasicBlock.Visitor() {
            public void visitBlock(com.droid.dx.ssa.SsaBasicBlock b, com.droid.dx.ssa.SsaBasicBlock parent) {
                ...
                if ((insns.size() == 1)
                    ...
                    for (int i = preds.nextSetBit(0); i >= 0;
                        ...
                        com.droid.dx.ssa.SsaBasicBlock pb = blocks.get(i);
    ...
    private void removePhiFunctions() {
        ...
        for (com.droid.dx.ssa.SsaBasicBlock block : blocks) {
    ...
    private static class PhiVisitor implements PhiInsn.Visitor {
        private final ArrayList<com.droid.dx.ssa.SsaBasicBlock> blocks;

        public PhiVisitor(ArrayList<com.droid.dx.ssa.SsaBasicBlock> blocks) {
            this.blocks = blocks;
        }
        ...
        public void visitPhiInsn(PhiInsn insn) {
            ...
            for (int i = 0; i < sz; i++) {
                ...
                com.droid.dx.ssa.SsaBasicBlock predBlock = blocks.get(
    ...
    private void moveParametersToHighRegisters() {
        ...
        com.droid.dx.ssa.BasicRegisterMapper mapper
                = new com.droid.dx.ssa.BasicRegisterMapper(ssaMeth.getRegCount());
    ...
    private BasicBlockList convertBasicBlocks() {
        ...
        com.droid.dx.ssa.SsaBasicBlock exitBlock = ssaMeth.getExitBlock();
        ...
        int ropBlockIndex = 0;
        for (com.droid.dx.ssa.SsaBasicBlock b : blocks) {
     ...
     */
    private void verifyValidExitPredecessor(com.droid.dx.ssa.SsaBasicBlock b) {
        ArrayList<SsaInsn> insns = b.getInsns();
     ...
     */
    private BasicBlock convertBasicBlock(com.droid.dx.ssa.SsaBasicBlock block) {
