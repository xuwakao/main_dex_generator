...
public final class Rops {
    ...
    public static final Rop NOP =
        new Rop(RegOps.NOP, Type.VOID, com.droid.dx.rop.type.StdTypeList.EMPTY, "nop");

    /** {@code r,x: int :: r = x;} */
    public static final Rop MOVE_INT =
        new Rop(RegOps.MOVE, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "move-int");

    /** {@code r,x: long :: r = x;} */
    public static final Rop MOVE_LONG =
        new Rop(RegOps.MOVE, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG, "move-long");

    /** {@code r,x: float :: r = x;} */
    public static final Rop MOVE_FLOAT =
        new Rop(RegOps.MOVE, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT, "move-float");

    /** {@code r,x: double :: r = x;} */
    public static final Rop MOVE_DOUBLE =
        new Rop(RegOps.MOVE, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE, "move-double");

    /** {@code r,x: Object :: r = x;} */
    public static final Rop MOVE_OBJECT =
        new Rop(RegOps.MOVE, Type.OBJECT, com.droid.dx.rop.type.StdTypeList.OBJECT, "move-object");
    ...
    public static final Rop MOVE_RETURN_ADDRESS =
        new Rop(RegOps.MOVE, Type.RETURN_ADDRESS,
                com.droid.dx.rop.type.StdTypeList.RETURN_ADDRESS, "move-return-address");

    /** {@code r,param(x): int :: r = param(x);} */
    public static final Rop MOVE_PARAM_INT =
        new Rop(RegOps.MOVE_PARAM, Type.INT, com.droid.dx.rop.type.StdTypeList.EMPTY,
                "move-param-int");

    /** {@code r,param(x): long :: r = param(x);} */
    public static final Rop MOVE_PARAM_LONG =
        new Rop(RegOps.MOVE_PARAM, Type.LONG, com.droid.dx.rop.type.StdTypeList.EMPTY,
                "move-param-long");

    /** {@code r,param(x): float :: r = param(x);} */
    public static final Rop MOVE_PARAM_FLOAT =
        new Rop(RegOps.MOVE_PARAM, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.EMPTY,
                "move-param-float");

    /** {@code r,param(x): double :: r = param(x);} */
    public static final Rop MOVE_PARAM_DOUBLE =
        new Rop(RegOps.MOVE_PARAM, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.EMPTY,
                "move-param-double");

    /** {@code r,param(x): Object :: r = param(x);} */
    public static final Rop MOVE_PARAM_OBJECT =
        new Rop(RegOps.MOVE_PARAM, Type.OBJECT, com.droid.dx.rop.type.StdTypeList.EMPTY,
                "move-param-object");

    /** {@code r, literal: int :: r = literal;} */
    public static final Rop CONST_INT =
        new Rop(RegOps.CONST, Type.INT, com.droid.dx.rop.type.StdTypeList.EMPTY, "const-int");

    /** {@code r, literal: long :: r = literal;} */
    public static final Rop CONST_LONG =
        new Rop(RegOps.CONST, Type.LONG, com.droid.dx.rop.type.StdTypeList.EMPTY, "const-long");

    /** {@code r, literal: float :: r = literal;} */
    public static final Rop CONST_FLOAT =
        new Rop(RegOps.CONST, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.EMPTY, "const-float");

    /** {@code r, literal: double :: r = literal;} */
    public static final Rop CONST_DOUBLE =
        new Rop(RegOps.CONST, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.EMPTY, "const-double");

    /** {@code r, literal: Object :: r = literal;} */
    public static final Rop CONST_OBJECT =
        new Rop(RegOps.CONST, Type.OBJECT, com.droid.dx.rop.type.StdTypeList.EMPTY,
    ...
    public static final Rop GOTO =
        new Rop(RegOps.GOTO, Type.VOID, com.droid.dx.rop.type.StdTypeList.EMPTY, Rop.BRANCH_GOTO,
                "goto");

    /** {@code x: int :: if (x == 0) goto label} */
    public static final Rop IF_EQZ_INT =
        new Rop(RegOps.IF_EQ, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT, Rop.BRANCH_IF,
                "if-eqz-int");

    /** {@code x: int :: if (x != 0) goto label} */
    public static final Rop IF_NEZ_INT =
        new Rop(RegOps.IF_NE, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT, Rop.BRANCH_IF,
                "if-nez-int");

    /** {@code x: int :: if (x < 0) goto label} */
    public static final Rop IF_LTZ_INT =
        new Rop(RegOps.IF_LT, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT, Rop.BRANCH_IF,
                "if-ltz-int");

    /** {@code x: int :: if (x >= 0) goto label} */
    public static final Rop IF_GEZ_INT =
        new Rop(RegOps.IF_GE, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT, Rop.BRANCH_IF,
                "if-gez-int");

    /** {@code x: int :: if (x <= 0) goto label} */
    public static final Rop IF_LEZ_INT =
        new Rop(RegOps.IF_LE, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT, Rop.BRANCH_IF,
                "if-lez-int");

    /** {@code x: int :: if (x > 0) goto label} */
    public static final Rop IF_GTZ_INT =
        new Rop(RegOps.IF_GT, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT, Rop.BRANCH_IF,
                "if-gtz-int");

    /** {@code x: Object :: if (x == null) goto label} */
    public static final Rop IF_EQZ_OBJECT =
        new Rop(RegOps.IF_EQ, Type.VOID, com.droid.dx.rop.type.StdTypeList.OBJECT, Rop.BRANCH_IF,
                "if-eqz-object");

    /** {@code x: Object :: if (x != null) goto label} */
    public static final Rop IF_NEZ_OBJECT =
        new Rop(RegOps.IF_NE, Type.VOID, com.droid.dx.rop.type.StdTypeList.OBJECT, Rop.BRANCH_IF,
                "if-nez-object");

    /** {@code x,y: int :: if (x == y) goto label} */
    public static final Rop IF_EQ_INT =
        new Rop(RegOps.IF_EQ, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_INT, Rop.BRANCH_IF,
                "if-eq-int");

    /** {@code x,y: int :: if (x != y) goto label} */
    public static final Rop IF_NE_INT =
        new Rop(RegOps.IF_NE, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_INT, Rop.BRANCH_IF,
                "if-ne-int");

    /** {@code x,y: int :: if (x < y) goto label} */
    public static final Rop IF_LT_INT =
        new Rop(RegOps.IF_LT, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_INT, Rop.BRANCH_IF,
                "if-lt-int");

    /** {@code x,y: int :: if (x >= y) goto label} */
    public static final Rop IF_GE_INT =
        new Rop(RegOps.IF_GE, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_INT, Rop.BRANCH_IF,
                "if-ge-int");

    /** {@code x,y: int :: if (x <= y) goto label} */
    public static final Rop IF_LE_INT =
        new Rop(RegOps.IF_LE, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_INT, Rop.BRANCH_IF,
                "if-le-int");

    /** {@code x,y: int :: if (x > y) goto label} */
    public static final Rop IF_GT_INT =
        new Rop(RegOps.IF_GT, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_INT, Rop.BRANCH_IF,
                "if-gt-int");

    /** {@code x,y: Object :: if (x == y) goto label} */
    public static final Rop IF_EQ_OBJECT =
        new Rop(RegOps.IF_EQ, Type.VOID, com.droid.dx.rop.type.StdTypeList.OBJECT_OBJECT,
                Rop.BRANCH_IF, "if-eq-object");

    /** {@code x,y: Object :: if (x != y) goto label} */
    public static final Rop IF_NE_OBJECT =
        new Rop(RegOps.IF_NE, Type.VOID, com.droid.dx.rop.type.StdTypeList.OBJECT_OBJECT,
                Rop.BRANCH_IF, "if-ne-object");

    /** {@code x: int :: goto switchtable[x]} */
    public static final Rop SWITCH =
        new Rop(RegOps.SWITCH, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT, Rop.BRANCH_SWITCH,
                "switch");

    /** {@code r,x,y: int :: r = x + y;} */
    public static final Rop ADD_INT =
        new Rop(RegOps.ADD, Type.INT, com.droid.dx.rop.type.StdTypeList.INT_INT, "add-int");

    /** {@code r,x,y: long :: r = x + y;} */
    public static final Rop ADD_LONG =
        new Rop(RegOps.ADD, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG_LONG, "add-long");

    /** {@code r,x,y: float :: r = x + y;} */
    public static final Rop ADD_FLOAT =
        new Rop(RegOps.ADD, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT_FLOAT, "add-float");

    /** {@code r,x,y: double :: r = x + y;} */
    public static final Rop ADD_DOUBLE =
        new Rop(RegOps.ADD, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE_DOUBLE,
                Rop.BRANCH_NONE, "add-double");

    /** {@code r,x,y: int :: r = x - y;} */
    public static final Rop SUB_INT =
        new Rop(RegOps.SUB, Type.INT, com.droid.dx.rop.type.StdTypeList.INT_INT, "sub-int");

    /** {@code r,x,y: long :: r = x - y;} */
    public static final Rop SUB_LONG =
        new Rop(RegOps.SUB, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG_LONG, "sub-long");

    /** {@code r,x,y: float :: r = x - y;} */
    public static final Rop SUB_FLOAT =
        new Rop(RegOps.SUB, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT_FLOAT, "sub-float");

    /** {@code r,x,y: double :: r = x - y;} */
    public static final Rop SUB_DOUBLE =
        new Rop(RegOps.SUB, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE_DOUBLE,
                Rop.BRANCH_NONE, "sub-double");

    /** {@code r,x,y: int :: r = x * y;} */
    public static final Rop MUL_INT =
        new Rop(RegOps.MUL, Type.INT, com.droid.dx.rop.type.StdTypeList.INT_INT, "mul-int");

    /** {@code r,x,y: long :: r = x * y;} */
    public static final Rop MUL_LONG =
        new Rop(RegOps.MUL, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG_LONG, "mul-long");

    /** {@code r,x,y: float :: r = x * y;} */
    public static final Rop MUL_FLOAT =
        new Rop(RegOps.MUL, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT_FLOAT, "mul-float");

    /** {@code r,x,y: double :: r = x * y;} */
    public static final Rop MUL_DOUBLE =
        new Rop(RegOps.MUL, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE_DOUBLE,
                Rop.BRANCH_NONE, "mul-double");

    /** {@code r,x,y: int :: r = x / y;} */
    public static final Rop DIV_INT =
        new Rop(RegOps.DIV, Type.INT, com.droid.dx.rop.type.StdTypeList.INT_INT,
                Exceptions.LIST_Error_ArithmeticException, "div-int");

    /** {@code r,x,y: long :: r = x / y;} */
    public static final Rop DIV_LONG =
        new Rop(RegOps.DIV, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG_LONG,
                Exceptions.LIST_Error_ArithmeticException, "div-long");

    /** {@code r,x,y: float :: r = x / y;} */
    public static final Rop DIV_FLOAT =
        new Rop(RegOps.DIV, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT_FLOAT, "div-float");

    /** {@code r,x,y: double :: r = x / y;} */
    public static final Rop DIV_DOUBLE =
        new Rop(RegOps.DIV, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE_DOUBLE,
                "div-double");

    /** {@code r,x,y: int :: r = x % y;} */
    public static final Rop REM_INT =
        new Rop(RegOps.REM, Type.INT, com.droid.dx.rop.type.StdTypeList.INT_INT,
                Exceptions.LIST_Error_ArithmeticException, "rem-int");

    /** {@code r,x,y: long :: r = x % y;} */
    public static final Rop REM_LONG =
        new Rop(RegOps.REM, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG_LONG,
                Exceptions.LIST_Error_ArithmeticException, "rem-long");

    /** {@code r,x,y: float :: r = x % y;} */
    public static final Rop REM_FLOAT =
        new Rop(RegOps.REM, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT_FLOAT, "rem-float");

    /** {@code r,x,y: double :: r = x % y;} */
    public static final Rop REM_DOUBLE =
        new Rop(RegOps.REM, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE_DOUBLE,
                "rem-double");

    /** {@code r,x: int :: r = -x;} */
    public static final Rop NEG_INT =
        new Rop(RegOps.NEG, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "neg-int");

    /** {@code r,x: long :: r = -x;} */
    public static final Rop NEG_LONG =
        new Rop(RegOps.NEG, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG, "neg-long");

    /** {@code r,x: float :: r = -x;} */
    public static final Rop NEG_FLOAT =
        new Rop(RegOps.NEG, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT, "neg-float");

    /** {@code r,x: double :: r = -x;} */
    public static final Rop NEG_DOUBLE =
        new Rop(RegOps.NEG, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE, "neg-double");

    /** {@code r,x,y: int :: r = x & y;} */
    public static final Rop AND_INT =
        new Rop(RegOps.AND, Type.INT, com.droid.dx.rop.type.StdTypeList.INT_INT, "and-int");

    /** {@code r,x,y: long :: r = x & y;} */
    public static final Rop AND_LONG =
        new Rop(RegOps.AND, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG_LONG, "and-long");

    /** {@code r,x,y: int :: r = x | y;} */
    public static final Rop OR_INT =
        new Rop(RegOps.OR, Type.INT, com.droid.dx.rop.type.StdTypeList.INT_INT, "or-int");

    /** {@code r,x,y: long :: r = x | y;} */
    public static final Rop OR_LONG =
        new Rop(RegOps.OR, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG_LONG, "or-long");

    /** {@code r,x,y: int :: r = x ^ y;} */
    public static final Rop XOR_INT =
        new Rop(RegOps.XOR, Type.INT, com.droid.dx.rop.type.StdTypeList.INT_INT, "xor-int");

    /** {@code r,x,y: long :: r = x ^ y;} */
    public static final Rop XOR_LONG =
        new Rop(RegOps.XOR, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG_LONG, "xor-long");

    /** {@code r,x,y: int :: r = x << y;} */
    public static final Rop SHL_INT =
        new Rop(RegOps.SHL, Type.INT, com.droid.dx.rop.type.StdTypeList.INT_INT, "shl-int");

    /** {@code r,x: long; y: int :: r = x << y;} */
    public static final Rop SHL_LONG =
        new Rop(RegOps.SHL, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG_INT, "shl-long");

    /** {@code r,x,y: int :: r = x >> y;} */
    public static final Rop SHR_INT =
        new Rop(RegOps.SHR, Type.INT, com.droid.dx.rop.type.StdTypeList.INT_INT, "shr-int");

    /** {@code r,x: long; y: int :: r = x >> y;} */
    public static final Rop SHR_LONG =
        new Rop(RegOps.SHR, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG_INT, "shr-long");

    /** {@code r,x,y: int :: r = x >>> y;} */
    public static final Rop USHR_INT =
        new Rop(RegOps.USHR, Type.INT, com.droid.dx.rop.type.StdTypeList.INT_INT, "ushr-int");

    /** {@code r,x: long; y: int :: r = x >>> y;} */
    public static final Rop USHR_LONG =
        new Rop(RegOps.USHR, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG_INT, "ushr-long");

    /** {@code r,x: int :: r = ~x;} */
    public static final Rop NOT_INT =
        new Rop(RegOps.NOT, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "not-int");

    /** {@code r,x: long :: r = ~x;} */
    public static final Rop NOT_LONG =
        new Rop(RegOps.NOT, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG, "not-long");

    /** {@code r,x,c: int :: r = x + c;} */
    public static final Rop ADD_CONST_INT =
        new Rop(RegOps.ADD, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "add-const-int");

    /** {@code r,x,c: long :: r = x + c;} */
    public static final Rop ADD_CONST_LONG =
        new Rop(RegOps.ADD, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG, "add-const-long");

    /** {@code r,x,c: float :: r = x + c;} */
    public static final Rop ADD_CONST_FLOAT =
        new Rop(RegOps.ADD, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT, "add-const-float");

    /** {@code r,x,c: double :: r = x + c;} */
    public static final Rop ADD_CONST_DOUBLE =
        new Rop(RegOps.ADD, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE,
                "add-const-double");

    /** {@code r,x,c: int :: r = x - c;} */
    public static final Rop SUB_CONST_INT =
        new Rop(RegOps.SUB, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "sub-const-int");

    /** {@code r,x,c: long :: r = x - c;} */
    public static final Rop SUB_CONST_LONG =
        new Rop(RegOps.SUB, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG, "sub-const-long");

    /** {@code r,x,c: float :: r = x - c;} */
    public static final Rop SUB_CONST_FLOAT =
        new Rop(RegOps.SUB, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT, "sub-const-float");

    /** {@code r,x,c: double :: r = x - c;} */
    public static final Rop SUB_CONST_DOUBLE =
        new Rop(RegOps.SUB, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE,
                "sub-const-double");

    /** {@code r,x,c: int :: r = x * c;} */
    public static final Rop MUL_CONST_INT =
        new Rop(RegOps.MUL, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "mul-const-int");

    /** {@code r,x,c: long :: r = x * c;} */
    public static final Rop MUL_CONST_LONG =
        new Rop(RegOps.MUL, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG, "mul-const-long");

    /** {@code r,x,c: float :: r = x * c;} */
    public static final Rop MUL_CONST_FLOAT =
        new Rop(RegOps.MUL, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT, "mul-const-float");

    /** {@code r,x,c: double :: r = x * c;} */
    public static final Rop MUL_CONST_DOUBLE =
        new Rop(RegOps.MUL, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE,
                "mul-const-double");

    /** {@code r,x,c: int :: r = x / c;} */
    public static final Rop DIV_CONST_INT =
        new Rop(RegOps.DIV, Type.INT, com.droid.dx.rop.type.StdTypeList.INT,
                Exceptions.LIST_Error_ArithmeticException, "div-const-int");

    /** {@code r,x,c: long :: r = x / c;} */
    public static final Rop DIV_CONST_LONG =
        new Rop(RegOps.DIV, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG,
                Exceptions.LIST_Error_ArithmeticException, "div-const-long");

    /** {@code r,x,c: float :: r = x / c;} */
    public static final Rop DIV_CONST_FLOAT =
        new Rop(RegOps.DIV, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT, "div-const-float");

    /** {@code r,x,c: double :: r = x / c;} */
    public static final Rop DIV_CONST_DOUBLE =
        new Rop(RegOps.DIV, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE,
                "div-const-double");

    /** {@code r,x,c: int :: r = x % c;} */
    public static final Rop REM_CONST_INT =
        new Rop(RegOps.REM, Type.INT, com.droid.dx.rop.type.StdTypeList.INT,
                Exceptions.LIST_Error_ArithmeticException, "rem-const-int");

    /** {@code r,x,c: long :: r = x % c;} */
    public static final Rop REM_CONST_LONG =
        new Rop(RegOps.REM, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG,
                Exceptions.LIST_Error_ArithmeticException, "rem-const-long");

    /** {@code r,x,c: float :: r = x % c;} */
    public static final Rop REM_CONST_FLOAT =
        new Rop(RegOps.REM, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOAT, "rem-const-float");

    /** {@code r,x,c: double :: r = x % c;} */
    public static final Rop REM_CONST_DOUBLE =
        new Rop(RegOps.REM, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLE,
                "rem-const-double");

    /** {@code r,x,c: int :: r = x & c;} */
    public static final Rop AND_CONST_INT =
        new Rop(RegOps.AND, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "and-const-int");

    /** {@code r,x,c: long :: r = x & c;} */
    public static final Rop AND_CONST_LONG =
        new Rop(RegOps.AND, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG, "and-const-long");

    /** {@code r,x,c: int :: r = x | c;} */
    public static final Rop OR_CONST_INT =
        new Rop(RegOps.OR, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "or-const-int");

    /** {@code r,x,c: long :: r = x | c;} */
    public static final Rop OR_CONST_LONG =
        new Rop(RegOps.OR, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG, "or-const-long");

    /** {@code r,x,c: int :: r = x ^ c;} */
    public static final Rop XOR_CONST_INT =
        new Rop(RegOps.XOR, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "xor-const-int");

    /** {@code r,x,c: long :: r = x ^ c;} */
    public static final Rop XOR_CONST_LONG =
        new Rop(RegOps.XOR, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONG, "xor-const-long");

    /** {@code r,x,c: int :: r = x << c;} */
    public static final Rop SHL_CONST_INT =
        new Rop(RegOps.SHL, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "shl-const-int");

    /** {@code r,x: long; c: int :: r = x << c;} */
    public static final Rop SHL_CONST_LONG =
        new Rop(RegOps.SHL, Type.LONG, com.droid.dx.rop.type.StdTypeList.INT, "shl-const-long");

    /** {@code r,x,c: int :: r = x >> c;} */
    public static final Rop SHR_CONST_INT =
        new Rop(RegOps.SHR, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "shr-const-int");

    /** {@code r,x: long; c: int :: r = x >> c;} */
    public static final Rop SHR_CONST_LONG =
        new Rop(RegOps.SHR, Type.LONG, com.droid.dx.rop.type.StdTypeList.INT, "shr-const-long");

    /** {@code r,x,c: int :: r = x >>> c;} */
    public static final Rop USHR_CONST_INT =
        new Rop(RegOps.USHR, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "ushr-const-int");

    /** {@code r,x: long; c: int :: r = x >>> c;} */
    public static final Rop USHR_CONST_LONG =
        new Rop(RegOps.USHR, Type.LONG, com.droid.dx.rop.type.StdTypeList.INT, "ushr-const-long");

    /** {@code r: int; x,y: long :: r = cmp(x, y);} */
    public static final Rop CMPL_LONG =
        new Rop(RegOps.CMPL, Type.INT, com.droid.dx.rop.type.StdTypeList.LONG_LONG, "cmpl-long");

    /** {@code r: int; x,y: float :: r = cmpl(x, y);} */
    public static final Rop CMPL_FLOAT =
        new Rop(RegOps.CMPL, Type.INT, com.droid.dx.rop.type.StdTypeList.FLOAT_FLOAT, "cmpl-float");

    /** {@code r: int; x,y: double :: r = cmpl(x, y);} */
    public static final Rop CMPL_DOUBLE =
        new Rop(RegOps.CMPL, Type.INT, com.droid.dx.rop.type.StdTypeList.DOUBLE_DOUBLE,
                "cmpl-double");

    /** {@code r: int; x,y: float :: r = cmpg(x, y);} */
    public static final Rop CMPG_FLOAT =
        new Rop(RegOps.CMPG, Type.INT, com.droid.dx.rop.type.StdTypeList.FLOAT_FLOAT, "cmpg-float");

    /** {@code r: int; x,y: double :: r = cmpg(x, y);} */
    public static final Rop CMPG_DOUBLE =
        new Rop(RegOps.CMPG, Type.INT, com.droid.dx.rop.type.StdTypeList.DOUBLE_DOUBLE,
                "cmpg-double");

    /** {@code r: int; x: long :: r = (int) x} */
    public static final Rop CONV_L2I =
        new Rop(RegOps.CONV, Type.INT, com.droid.dx.rop.type.StdTypeList.LONG, "conv-l2i");

    /** {@code r: int; x: float :: r = (int) x} */
    public static final Rop CONV_F2I =
        new Rop(RegOps.CONV, Type.INT, com.droid.dx.rop.type.StdTypeList.FLOAT, "conv-f2i");

    /** {@code r: int; x: double :: r = (int) x} */
    public static final Rop CONV_D2I =
        new Rop(RegOps.CONV, Type.INT, com.droid.dx.rop.type.StdTypeList.DOUBLE, "conv-d2i");

    /** {@code r: long; x: int :: r = (long) x} */
    public static final Rop CONV_I2L =
        new Rop(RegOps.CONV, Type.LONG, com.droid.dx.rop.type.StdTypeList.INT, "conv-i2l");

    /** {@code r: long; x: float :: r = (long) x} */
    public static final Rop CONV_F2L =
        new Rop(RegOps.CONV, Type.LONG, com.droid.dx.rop.type.StdTypeList.FLOAT, "conv-f2l");

    /** {@code r: long; x: double :: r = (long) x} */
    public static final Rop CONV_D2L =
        new Rop(RegOps.CONV, Type.LONG, com.droid.dx.rop.type.StdTypeList.DOUBLE, "conv-d2l");

    /** {@code r: float; x: int :: r = (float) x} */
    public static final Rop CONV_I2F =
        new Rop(RegOps.CONV, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.INT, "conv-i2f");

    /** {@code r: float; x: long :: r = (float) x} */
    public static final Rop CONV_L2F =
        new Rop(RegOps.CONV, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.LONG, "conv-l2f");

    /** {@code r: float; x: double :: r = (float) x} */
    public static final Rop CONV_D2F =
        new Rop(RegOps.CONV, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.DOUBLE, "conv-d2f");

    /** {@code r: double; x: int :: r = (double) x} */
    public static final Rop CONV_I2D =
        new Rop(RegOps.CONV, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.INT, "conv-i2d");

    /** {@code r: double; x: long :: r = (double) x} */
    public static final Rop CONV_L2D =
        new Rop(RegOps.CONV, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.LONG, "conv-l2d");

    /** {@code r: double; x: float :: r = (double) x} */
    public static final Rop CONV_F2D =
        new Rop(RegOps.CONV, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.FLOAT, "conv-f2d");
    ...
    public static final Rop TO_BYTE =
        new Rop(RegOps.TO_BYTE, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "to-byte");
    ...
    public static final Rop TO_CHAR =
        new Rop(RegOps.TO_CHAR, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "to-char");
    ...
    public static final Rop TO_SHORT =
        new Rop(RegOps.TO_SHORT, Type.INT, com.droid.dx.rop.type.StdTypeList.INT, "to-short");

    /** {@code return void} */
    public static final Rop RETURN_VOID =
        new Rop(RegOps.RETURN, Type.VOID, com.droid.dx.rop.type.StdTypeList.EMPTY, Rop.BRANCH_RETURN,
                "return-void");

    /** {@code x: int; return x} */
    public static final Rop RETURN_INT =
        new Rop(RegOps.RETURN, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT, Rop.BRANCH_RETURN,
                "return-int");

    /** {@code x: long; return x} */
    public static final Rop RETURN_LONG =
        new Rop(RegOps.RETURN, Type.VOID, com.droid.dx.rop.type.StdTypeList.LONG, Rop.BRANCH_RETURN,
                "return-long");

    /** {@code x: float; return x} */
    public static final Rop RETURN_FLOAT =
        new Rop(RegOps.RETURN, Type.VOID, com.droid.dx.rop.type.StdTypeList.FLOAT, Rop.BRANCH_RETURN,
                "return-float");

    /** {@code x: double; return x} */
    public static final Rop RETURN_DOUBLE =
        new Rop(RegOps.RETURN, Type.VOID, com.droid.dx.rop.type.StdTypeList.DOUBLE,
                Rop.BRANCH_RETURN, "return-double");

    /** {@code x: Object; return x} */
    public static final Rop RETURN_OBJECT =
        new Rop(RegOps.RETURN, Type.VOID, com.droid.dx.rop.type.StdTypeList.OBJECT,
                Rop.BRANCH_RETURN, "return-object");

    /** {@code T: any type; r: int; x: T[]; :: r = x.length} */
    public static final Rop ARRAY_LENGTH =
        new Rop(RegOps.ARRAY_LENGTH, Type.INT, com.droid.dx.rop.type.StdTypeList.OBJECT,
                Exceptions.LIST_Error_NullPointerException, "array-length");

    /** {@code x: Throwable :: throw(x)} */
    public static final Rop THROW =
        new Rop(RegOps.THROW, Type.VOID, com.droid.dx.rop.type.StdTypeList.THROWABLE,
                com.droid.dx.rop.type.StdTypeList.THROWABLE, "throw");

    /** {@code x: Object :: monitorenter(x)} */
    public static final Rop MONITOR_ENTER =
        new Rop(RegOps.MONITOR_ENTER, Type.VOID, com.droid.dx.rop.type.StdTypeList.OBJECT,
                Exceptions.LIST_Error_NullPointerException, "monitor-enter");

    /** {@code x: Object :: monitorexit(x)} */
    public static final Rop MONITOR_EXIT =
        new Rop(RegOps.MONITOR_EXIT, Type.VOID, com.droid.dx.rop.type.StdTypeList.OBJECT,
                Exceptions.LIST_Error_Null_IllegalMonitorStateException,
                "monitor-exit");

    /** {@code r,y: int; x: int[] :: r = x[y]} */
    public static final Rop AGET_INT =
        new Rop(RegOps.AGET, Type.INT, com.droid.dx.rop.type.StdTypeList.INTARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndexOutOfBounds,
                "aget-int");

    /** {@code r: long; x: long[]; y: int :: r = x[y]} */
    public static final Rop AGET_LONG =
        new Rop(RegOps.AGET, Type.LONG, com.droid.dx.rop.type.StdTypeList.LONGARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndexOutOfBounds,
                "aget-long");

    /** {@code r: float; x: float[]; y: int :: r = x[y]} */
    public static final Rop AGET_FLOAT =
        new Rop(RegOps.AGET, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.FLOATARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndexOutOfBounds,
                "aget-float");

    /** {@code r: double; x: double[]; y: int :: r = x[y]} */
    public static final Rop AGET_DOUBLE =
        new Rop(RegOps.AGET, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.DOUBLEARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndexOutOfBounds,
                "aget-double");

    /** {@code r: Object; x: Object[]; y: int :: r = x[y]} */
    public static final Rop AGET_OBJECT =
        new Rop(RegOps.AGET, Type.OBJECT, com.droid.dx.rop.type.StdTypeList.OBJECTARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndexOutOfBounds,
                "aget-object");

    /** {@code r: boolean; x: boolean[]; y: int :: r = x[y]} */
    public static final Rop AGET_BOOLEAN =
        new Rop(RegOps.AGET, Type.INT, com.droid.dx.rop.type.StdTypeList.BOOLEANARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndexOutOfBounds,
                "aget-boolean");

    /** {@code r: byte; x: byte[]; y: int :: r = x[y]} */
    public static final Rop AGET_BYTE =
        new Rop(RegOps.AGET, Type.INT, com.droid.dx.rop.type.StdTypeList.BYTEARR_INT,
    ...
    public static final Rop AGET_CHAR =
        new Rop(RegOps.AGET, Type.INT, com.droid.dx.rop.type.StdTypeList.CHARARR_INT,
    ...
    public static final Rop AGET_SHORT =
        new Rop(RegOps.AGET, Type.INT, com.droid.dx.rop.type.StdTypeList.SHORTARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndexOutOfBounds,
                "aget-short");

    /** {@code x,z: int; y: int[] :: y[z] = x} */
    public static final Rop APUT_INT =
        new Rop(RegOps.APUT, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_INTARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndexOutOfBounds, "aput-int");

    /** {@code x: long; y: long[]; z: int :: y[z] = x} */
    public static final Rop APUT_LONG =
        new Rop(RegOps.APUT, Type.VOID, com.droid.dx.rop.type.StdTypeList.LONG_LONGARR_INT,
    ...
    public static final Rop APUT_FLOAT =
        new Rop(RegOps.APUT, Type.VOID, com.droid.dx.rop.type.StdTypeList.FLOAT_FLOATARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndexOutOfBounds,
                "aput-float");

    /** {@code x: double; y: double[]; z: int :: y[z] = x} */
    public static final Rop APUT_DOUBLE =
        new Rop(RegOps.APUT, Type.VOID, com.droid.dx.rop.type.StdTypeList.DOUBLE_DOUBLEARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndexOutOfBounds,
                "aput-double");

    /** {@code x: Object; y: Object[]; z: int :: y[z] = x} */
    public static final Rop APUT_OBJECT =
        new Rop(RegOps.APUT, Type.VOID, com.droid.dx.rop.type.StdTypeList.OBJECT_OBJECTARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndex_ArrayStore,
                "aput-object");

    /** {@code x: boolean; y: boolean[]; z: int :: y[z] = x} */
    public static final Rop APUT_BOOLEAN =
        new Rop(RegOps.APUT, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_BOOLEANARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndex_ArrayStore,
                "aput-boolean");

    /** {@code x: byte; y: byte[]; z: int :: y[z] = x} */
    public static final Rop APUT_BYTE =
        new Rop(RegOps.APUT, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_BYTEARR_INT,
    ...
    public static final Rop APUT_CHAR =
        new Rop(RegOps.APUT, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_CHARARR_INT,
    ...
    public static final Rop APUT_SHORT =
        new Rop(RegOps.APUT, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_SHORTARR_INT,
                Exceptions.LIST_Error_Null_ArrayIndex_ArrayStore,
                "aput-short");
    ...
    public static final Rop NEW_INSTANCE =
        new Rop(RegOps.NEW_INSTANCE, Type.OBJECT, com.droid.dx.rop.type.StdTypeList.EMPTY,
                Exceptions.LIST_Error, "new-instance");

    /** {@code r: int[]; x: int :: r = new int[x]} */
    public static final Rop NEW_ARRAY_INT =
        new Rop(RegOps.NEW_ARRAY, Type.INT_ARRAY, com.droid.dx.rop.type.StdTypeList.INT,
                Exceptions.LIST_Error_NegativeArraySizeException,
                "new-array-int");

    /** {@code r: long[]; x: int :: r = new long[x]} */
    public static final Rop NEW_ARRAY_LONG =
        new Rop(RegOps.NEW_ARRAY, Type.LONG_ARRAY, com.droid.dx.rop.type.StdTypeList.INT,
                Exceptions.LIST_Error_NegativeArraySizeException,
                "new-array-long");

    /** {@code r: float[]; x: int :: r = new float[x]} */
    public static final Rop NEW_ARRAY_FLOAT =
        new Rop(RegOps.NEW_ARRAY, Type.FLOAT_ARRAY, com.droid.dx.rop.type.StdTypeList.INT,
                Exceptions.LIST_Error_NegativeArraySizeException,
                "new-array-float");

    /** {@code r: double[]; x: int :: r = new double[x]} */
    public static final Rop NEW_ARRAY_DOUBLE =
        new Rop(RegOps.NEW_ARRAY, Type.DOUBLE_ARRAY, com.droid.dx.rop.type.StdTypeList.INT,
                Exceptions.LIST_Error_NegativeArraySizeException,
                "new-array-double");

    /** {@code r: boolean[]; x: int :: r = new boolean[x]} */
    public static final Rop NEW_ARRAY_BOOLEAN =
        new Rop(RegOps.NEW_ARRAY, Type.BOOLEAN_ARRAY, com.droid.dx.rop.type.StdTypeList.INT,
                Exceptions.LIST_Error_NegativeArraySizeException,
                "new-array-boolean");

    /** {@code r: byte[]; x: int :: r = new byte[x]} */
    public static final Rop NEW_ARRAY_BYTE =
        new Rop(RegOps.NEW_ARRAY, Type.BYTE_ARRAY, com.droid.dx.rop.type.StdTypeList.INT,
                Exceptions.LIST_Error_NegativeArraySizeException,
                "new-array-byte");

    /** {@code r: char[]; x: int :: r = new char[x]} */
    public static final Rop NEW_ARRAY_CHAR =
        new Rop(RegOps.NEW_ARRAY, Type.CHAR_ARRAY, com.droid.dx.rop.type.StdTypeList.INT,
                Exceptions.LIST_Error_NegativeArraySizeException,
                "new-array-char");

    /** {@code r: short[]; x: int :: r = new short[x]} */
    public static final Rop NEW_ARRAY_SHORT =
        new Rop(RegOps.NEW_ARRAY, Type.SHORT_ARRAY, com.droid.dx.rop.type.StdTypeList.INT,
                Exceptions.LIST_Error_NegativeArraySizeException,
                "new-array-short");
    ...
    public static final Rop CHECK_CAST =
        new Rop(RegOps.CHECK_CAST, Type.VOID, com.droid.dx.rop.type.StdTypeList.OBJECT,
    ...
    public static final Rop INSTANCE_OF =
        new Rop(RegOps.INSTANCE_OF, Type.INT, com.droid.dx.rop.type.StdTypeList.OBJECT,
    ...
    public static final Rop GET_FIELD_INT =
        new Rop(RegOps.GET_FIELD, Type.INT, com.droid.dx.rop.type.StdTypeList.OBJECT,
    ...
    public static final Rop GET_FIELD_LONG =
        new Rop(RegOps.GET_FIELD, Type.LONG, com.droid.dx.rop.type.StdTypeList.OBJECT,
    ...
    public static final Rop GET_FIELD_FLOAT =
        new Rop(RegOps.GET_FIELD, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.OBJECT,
    ...
    public static final Rop GET_FIELD_DOUBLE =
        new Rop(RegOps.GET_FIELD, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.OBJECT,
                Exceptions.LIST_Error_NullPointerException,
                "get-field-double");
    ...
    public static final Rop GET_FIELD_OBJECT =
        new Rop(RegOps.GET_FIELD, Type.OBJECT, com.droid.dx.rop.type.StdTypeList.OBJECT,
                Exceptions.LIST_Error_NullPointerException,
                "get-field-object");
    ...
    public static final Rop GET_STATIC_INT =
        new Rop(RegOps.GET_STATIC, Type.INT, com.droid.dx.rop.type.StdTypeList.EMPTY,
    ...
    public static final Rop GET_STATIC_LONG =
        new Rop(RegOps.GET_STATIC, Type.LONG, com.droid.dx.rop.type.StdTypeList.EMPTY,
    ...
    public static final Rop GET_STATIC_FLOAT =
        new Rop(RegOps.GET_STATIC, Type.FLOAT, com.droid.dx.rop.type.StdTypeList.EMPTY,
    ...
    public static final Rop GET_STATIC_DOUBLE =
        new Rop(RegOps.GET_STATIC, Type.DOUBLE, com.droid.dx.rop.type.StdTypeList.EMPTY,
    ...
    public static final Rop GET_STATIC_OBJECT =
        new Rop(RegOps.GET_STATIC, Type.OBJECT, com.droid.dx.rop.type.StdTypeList.EMPTY,
    ...
    public static final Rop PUT_FIELD_INT =
        new Rop(RegOps.PUT_FIELD, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT_OBJECT,
    ...
    public static final Rop PUT_FIELD_LONG =
        new Rop(RegOps.PUT_FIELD, Type.VOID, com.droid.dx.rop.type.StdTypeList.LONG_OBJECT,
    ...
    public static final Rop PUT_FIELD_FLOAT =
        new Rop(RegOps.PUT_FIELD, Type.VOID, com.droid.dx.rop.type.StdTypeList.FLOAT_OBJECT,
                Exceptions.LIST_Error_NullPointerException,
                "put-field-float");
    ...
    public static final Rop PUT_FIELD_DOUBLE =
        new Rop(RegOps.PUT_FIELD, Type.VOID, com.droid.dx.rop.type.StdTypeList.DOUBLE_OBJECT,
                Exceptions.LIST_Error_NullPointerException,
                "put-field-double");
    ...
    public static final Rop PUT_FIELD_OBJECT =
        new Rop(RegOps.PUT_FIELD, Type.VOID, com.droid.dx.rop.type.StdTypeList.OBJECT_OBJECT,
                Exceptions.LIST_Error_NullPointerException,
                "put-field-object");
    ...
    public static final Rop PUT_STATIC_INT =
        new Rop(RegOps.PUT_STATIC, Type.VOID, com.droid.dx.rop.type.StdTypeList.INT,
    ...
    public static final Rop PUT_STATIC_LONG =
        new Rop(RegOps.PUT_STATIC, Type.VOID, com.droid.dx.rop.type.StdTypeList.LONG,
    ...
    public static final Rop PUT_STATIC_FLOAT =
        new Rop(RegOps.PUT_STATIC, Type.VOID, com.droid.dx.rop.type.StdTypeList.FLOAT,
    ...
    public static final Rop PUT_STATIC_DOUBLE =
        new Rop(RegOps.PUT_STATIC, Type.VOID, com.droid.dx.rop.type.StdTypeList.DOUBLE,
    ...
    public static final Rop PUT_STATIC_OBJECT =
        new Rop(RegOps.PUT_STATIC, Type.VOID, com.droid.dx.rop.type.StdTypeList.OBJECT,
     ...
     */
    public static Rop ropFor(int opcode, TypeBearer dest, com.droid.dx.rop.type.TypeList sources,
                             Constant cst) {
        switch (opcode) {
            ...
            case RegOps.INVOKE_STATIC: {
                return opInvokeStatic(((com.droid.dx.rop.cst.CstMethodRef) cst).getPrototype());
            }
            case RegOps.INVOKE_VIRTUAL: {
                CstBaseMethodRef cstMeth = (com.droid.dx.rop.cst.CstMethodRef) cst;
    ...
    public static Rop opMoveException(TypeBearer type) {
        return new Rop(RegOps.MOVE_EXCEPTION, type.getType(),
                       com.droid.dx.rop.type.StdTypeList.EMPTY, (String) null);
    }
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opIfEq(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opIfNe(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opIfLt(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opIfGe(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opIfGt(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opIfLe(com.droid.dx.rop.type.TypeList types) {
     ...
     */
    private static Rop pickIf(com.droid.dx.rop.type.TypeList types, Rop intZ, Rop objZ, Rop intInt,
                              Rop objObj) {
        switch(types.size()) {
            case 1: {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opAdd(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opSub(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opMul(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opDiv(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opRem(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opAnd(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opOr(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opXor(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opShl(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opShr(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    public static Rop opUshr(com.droid.dx.rop.type.TypeList types) {
     ...
     * @return {@code non-null;} an appropriate instance
     */
    private static Rop pickBinaryOp(com.droid.dx.rop.type.TypeList types, Rop int1, Rop long1,
    ...
    public static Rop opConv(TypeBearer dest, TypeBearer source) {
        ...
        return throwBadTypes(com.droid.dx.rop.type.StdTypeList.make(dest.getType(),
                                              source.getType()));
    }
    ...
    public static Rop opNewArray(TypeBearer arrayType) {
        ...
        switch (elementType.getBasicType()) {
            ...
            case Type.BT_OBJECT: {
                return new Rop(RegOps.NEW_ARRAY, type, com.droid.dx.rop.type.StdTypeList.INT,
                        Exceptions.LIST_Error_NegativeArraySizeException,
                        "new-array-object");
            }
        }
    ...
    public static Rop opFilledNewArray(TypeBearer arrayType, int count) {
        ...
        com.droid.dx.rop.type.StdTypeList sourceTypes = new com.droid.dx.rop.type.StdTypeList(count);
    ...
    public static Rop opInvokeStatic(Prototype meth) {
        return new Rop(RegOps.INVOKE_STATIC,
                       ...
                       com.droid.dx.rop.type.StdTypeList.THROWABLE);
    }
     ...
     * @return never
     */
    private static Rop throwBadTypes(com.droid.dx.rop.type.TypeList types) {
