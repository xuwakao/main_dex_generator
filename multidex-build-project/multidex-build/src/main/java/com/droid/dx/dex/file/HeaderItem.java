...
public final class HeaderItem extends IndexedItem {
    ...
    public int writeSize() {
        return com.droid.dex.SizeOf.HEADER_ITEM;
    }
    ...
    public void writeTo(DexFile file, AnnotatedOutput out) {
        ...
        if (out.annotates()) {
            out.annotate(8, "magic: " + new com.droid.dx.rop.cst.CstString(magic).toQuoted());
            out.annotate(4, "checksum");
            out.annotate(20, "signature");
            out.annotate(4, "file_size:       " +
                         Hex.u4(file.getFileSize()));
            out.annotate(4, "header_size:     " + Hex.u4(com.droid.dex.SizeOf.HEADER_ITEM));
            out.annotate(4, "endian_tag:      " + Hex.u4(com.droid.dex.DexFormat.ENDIAN_TAG));
