...
public final class RegisterSpec
    ...
    /** {@inheritDoc} */
    public com.droid.dx.rop.type.Type getType() {
        return type.getType();
    }
    ...
    public RegisterSpec intersect(RegisterSpec other, boolean localPrimary) {
        ...
        com.droid.dx.rop.type.Type thisType = getType();
        com.droid.dx.rop.type.Type otherType = other.getType();
    ...
    public RegisterSpec withSimpleType() {
        ...
        com.droid.dx.rop.type.Type newType;

        if (orig instanceof com.droid.dx.rop.type.Type) {
            newType = (com.droid.dx.rop.type.Type) orig;
        } else {
    ...
    private String toString0(boolean human) {
        ...
        com.droid.dx.rop.type.Type justType = type.getType();
        sb.append(justType);

        if (justType != type) {
            sb.append("=");
            if (human && (type instanceof com.droid.dx.rop.cst.CstString)) {
                sb.append(((com.droid.dx.rop.cst.CstString) type).toQuoted());
