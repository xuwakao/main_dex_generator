...
public class DebugInfoItem extends OffsettedItem {
    ...
    public DebugInfoItem(com.droid.dx.dex.code.DalvCode code, boolean isStatic, com.droid.dx.rop.cst.CstMethodRef ref) {
     ...
     */
    public void annotateTo(DexFile file, com.droid.dx.util.AnnotatedOutput out, String prefix) {
    ...
    private byte[] encode0(DexFile file, String prefix, PrintWriter debugPrint,
                           com.droid.dx.util.AnnotatedOutput out, boolean consume) {
        com.droid.dx.dex.code.PositionList positions = code.getPositions();
        com.droid.dx.dex.code.LocalList locals = code.getLocals();
