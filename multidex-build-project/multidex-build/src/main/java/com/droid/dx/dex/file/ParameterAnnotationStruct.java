...
import com.droid.dx.util.ToHuman;
...
public final class ParameterAnnotationStruct
    ...
    private final com.droid.dx.rop.cst.CstMethodRef method;
    ...
    private final UniformListItem<com.droid.dx.dex.file.AnnotationSetRefItem> annotationsItem;
     ...
     */
    public ParameterAnnotationStruct(com.droid.dx.rop.cst.CstMethodRef method,
                                     AnnotationsList annotationsList, com.droid.dx.dex.file.DexFile dexFile) {
        if (method == null) {
        ...
        ArrayList<com.droid.dx.dex.file.AnnotationSetRefItem> arrayList = new
            ArrayList<com.droid.dx.dex.file.AnnotationSetRefItem>(size);

        for (int i = 0; i < size; i++) {
            Annotations annotations = annotationsList.get(i);
            AnnotationSetItem item = new AnnotationSetItem(annotations, dexFile);
            arrayList.add(new com.droid.dx.dex.file.AnnotationSetRefItem(item));
        }

        this.annotationsItem = new UniformListItem<com.droid.dx.dex.file.AnnotationSetRefItem>(
                com.droid.dx.dex.file.ItemType.TYPE_ANNOTATION_SET_REF_LIST, arrayList);
    }
    ...
    public void addContents(com.droid.dx.dex.file.DexFile file) {
        com.droid.dx.dex.file.MethodIdsSection methodIds = file.getMethodIds();
    ...
    public String toHuman() {
        ...
        boolean first = true;
        for (com.droid.dx.dex.file.AnnotationSetRefItem item : annotationsItem.getItems()) {
            if (first) {
                first = false;
            } else {
                sb.append(", ");
     ...
     */
    public com.droid.dx.rop.cst.CstMethodRef getMethod() {
        return method;
    }
