...
public final class InnerClassList extends FixedSizeList {
    ...
    public void set(int n, CstType innerClass, CstType outerClass,
                    com.droid.dx.rop.cst.CstString innerName, int accessFlags) {
    ...
    public static class Item {
        ...
        private final com.droid.dx.rop.cst.CstString innerName;
         ...
         */
        public com.droid.dx.rop.cst.CstString getInnerName() {
            return innerName;
        }
