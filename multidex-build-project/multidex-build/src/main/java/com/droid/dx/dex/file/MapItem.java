    ...
    protected void writeTo0(DexFile file, com.droid.dx.util.AnnotatedOutput out) {
        ...
        if (out.annotates()) {
            out.annotate(0, offsetString() + ' ' + type.getTypeName() +
                    " map");
            out.annotate(2, "  type:   " + com.droid.dx.util.Hex.u2(value) + " // " +
                    type.toString());
            out.annotate(2, "  unused: 0");
            out.annotate(4, "  size:   " + com.droid.dx.util.Hex.u4(itemCount));
            out.annotate(4, "  offset: " + com.droid.dx.util.Hex.u4(offset));
        }
