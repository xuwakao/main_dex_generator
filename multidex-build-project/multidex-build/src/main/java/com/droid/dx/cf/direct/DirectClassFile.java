...
import com.droid.dx.cf.cst.ConstantPoolParser;
...
import com.droid.dx.rop.code.AccessFlags;
...
public class DirectClassFile implements ClassFile {
    ...
    private com.droid.dx.cf.direct.AttributeFactory attributeFactory;
     ...
     */
    public void setAttributeFactory(com.droid.dx.cf.direct.AttributeFactory attributeFactory) {
    ...
    private void parse0() {
        ...
        com.droid.dx.cf.direct.MethodListParser mlParser =
            new com.droid.dx.cf.direct.MethodListParser(this, thisClass, at, attributeFactory);
        mlParser.setObserver(observer);
        methods = mlParser.getList();
        at = mlParser.getEndOffset();

        com.droid.dx.cf.direct.AttributeListParser alParser =
            new com.droid.dx.cf.direct.AttributeListParser(this, com.droid.dx.cf.direct.AttributeFactory.CTX_CLASS, at,
                                    attributeFactory);
    ...
    private static class DcfTypeList implements TypeList {
        ...
        public DcfTypeList(ByteArray bytes, int offset, int size,
                StdConstantPool pool, com.droid.dx.cf.iface.ParseObserver observer) {
            if (size < 0) {
