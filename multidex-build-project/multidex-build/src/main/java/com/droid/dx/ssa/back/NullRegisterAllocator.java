...
public class NullRegisterAllocator extends RegisterAllocator {
    /** {@inheritDoc} */
    public NullRegisterAllocator(com.droid.dx.ssa.SsaMethod ssaMeth,
    ...
    public com.droid.dx.ssa.RegisterMapper allocateRegisters() {
        ...
        com.droid.dx.ssa.BasicRegisterMapper mapper = new com.droid.dx.ssa.BasicRegisterMapper(oldRegCount);
