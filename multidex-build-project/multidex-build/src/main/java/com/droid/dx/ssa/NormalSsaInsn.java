...
public final class NormalSsaInsn extends SsaInsn implements Cloneable {
    ...
    /** {@inheritDoc} */
    @Override
    public final void mapSourceRegisters(com.droid.dx.ssa.RegisterMapper mapper) {
    ...
    public RegisterSpec getLocalAssignment() {
        ...
        if (insn.getOpcode().getOpcode() == com.droid.dx.rop.code.RegOps.MARK_LOCAL) {
    ...
    public boolean isNormalMoveInsn() {
        return insn.getOpcode().getOpcode() == com.droid.dx.rop.code.RegOps.MOVE;
    }

    /** {@inheritDoc} */
    @Override
    public boolean isMoveException() {
        return insn.getOpcode().getOpcode() == com.droid.dx.rop.code.RegOps.MOVE_EXCEPTION;
    }
    ...
    public boolean hasSideEffect() {
        ...
        switch (opcode.getOpcode()) {
            case com.droid.dx.rop.code.RegOps.MOVE_RESULT:
