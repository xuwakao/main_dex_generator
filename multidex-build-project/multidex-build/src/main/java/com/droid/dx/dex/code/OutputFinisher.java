...
import com.droid.dx.io.Opcodes;
...
import com.droid.dx.rop.cst.CstMemberRef;
...
public final class OutputFinisher {
    ...
    private ArrayList<com.droid.dx.dex.code.DalvInsn> insns;
    ...
    public OutputFinisher(DexOptions dexOptions, int initialCapacity, int regCount, int paramSize) {
        ...
        this.insns = new ArrayList<com.droid.dx.dex.code.DalvInsn>(initialCapacity);
     ...
     * named locals
     */
    private static boolean hasLocalInfo(com.droid.dx.dex.code.DalvInsn insn) {
        ...
        } else if (insn instanceof com.droid.dx.dex.code.LocalStart) {
            RegisterSpec spec = ((com.droid.dx.dex.code.LocalStart) insn).getLocal();
    ...
    public HashSet<Constant> getAllConstants() {
        ...
        for (com.droid.dx.dex.code.DalvInsn insn : insns) {
    ...
    private static void addConstants(HashSet<Constant> result,
            com.droid.dx.dex.code.DalvInsn insn) {
        if (insn instanceof com.droid.dx.dex.code.CstInsn) {
            Constant cst = ((com.droid.dx.dex.code.CstInsn) insn).getConstant();
            result.add(cst);
    ...
    private static void addConstants(HashSet<Constant> result,
        ...
        com.droid.dx.rop.code.LocalItem local = spec.getLocalItem();
        com.droid.dx.rop.cst.CstString name = local.getName();
        com.droid.dx.rop.cst.CstString signature = local.getSignature();
     ...
     */
    public void add(com.droid.dx.dex.code.DalvInsn insn) {
        insns.add(insn);
        updateInfo(insn);
    }
     ...
     */
    public void insert(int at, com.droid.dx.dex.code.DalvInsn insn) {
        insns.add(at, insn);
        updateInfo(insn);
    }
     ...
     */
    private void updateInfo(com.droid.dx.dex.code.DalvInsn insn) {
    ...
    public void reverseBranch(int which, CodeAddress newTarget) {
        ...
        com.droid.dx.dex.code.TargetInsn targetInsn;

        try {
            targetInsn = (com.droid.dx.dex.code.TargetInsn) insns.get(index);
     ...
     */
    public void assignIndices(com.droid.dx.dex.code.DalvCode.AssignIndicesCallback callback) {
        for (com.droid.dx.dex.code.DalvInsn insn : insns) {
            if (insn instanceof com.droid.dx.dex.code.CstInsn) {
                assignIndices((com.droid.dx.dex.code.CstInsn) insn, callback);
            }
        }
    }
     ...
     */
    private static void assignIndices(com.droid.dx.dex.code.CstInsn insn,
                                      com.droid.dx.dex.code.DalvCode.AssignIndicesCallback callback) {
    ...
    private boolean reserveRegisters(Dop[] opcodes) {
        ...
        for (;;) {
            ...
            for (int i = 0; i < size; i++) {
                 ...
                 * test below.
                 */
                com.droid.dx.dex.code.DalvInsn insn = insns.get(i);
     ...
     * simple opcode fits
     */
    private Dop findOpcodeForInsn(com.droid.dx.dex.code.DalvInsn insn, Dop guess) {
        /*
     ...
     */
    private Dop findExpandedOpcodeForInsn(com.droid.dx.dex.code.DalvInsn insn) {
     ...
     */
    private ArrayList<com.droid.dx.dex.code.DalvInsn> performExpansion(Dop[] opcodes) {
        int size = insns.size();
        ArrayList<com.droid.dx.dex.code.DalvInsn> result = new ArrayList<com.droid.dx.dex.code.DalvInsn>(size * 2);
        ...
        for (int i = 0; i < size; i++) {
            ...
            Dop originalOpcode = insn.getOpcode();
            Dop currentOpcode = opcodes[i];
            com.droid.dx.dex.code.DalvInsn prefix;
            com.droid.dx.dex.code.DalvInsn suffix;
            ...
            if (!(insn instanceof com.droid.dx.dex.code.ZeroSizeInsn) && closelyBoundAddresses.size() > 0) {
    ...
    private boolean fixBranches() {
        ...
        for (int i = 0; i < size; i++) {
            com.droid.dx.dex.code.DalvInsn insn = insns.get(i);
            if (!(insn instanceof com.droid.dx.dex.code.TargetInsn)) {
                // This loop only needs to inspect TargetInsns.
                continue;
            }

            Dop opcode = insn.getOpcode();
            com.droid.dx.dex.code.TargetInsn target = (com.droid.dx.dex.code.TargetInsn) insn;
            ...
            if (opcode.getFamily() == Opcodes.GOTO) {
                ...
                com.droid.dx.dex.code.TargetInsn gotoInsn =
                    new com.droid.dx.dex.code.TargetInsn(Dops.GOTO, target.getPosition(),
    ...
    private void shiftParameters(int delta) {
      ...
      com.droid.dx.ssa.BasicRegisterMapper mapper = new com.droid.dx.ssa.BasicRegisterMapper(lastParameter);
