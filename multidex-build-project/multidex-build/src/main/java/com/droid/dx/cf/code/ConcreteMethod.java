...
import com.droid.dx.cf.iface.AttributeList;
import com.droid.dx.cf.iface.ClassFile;
...
public final class ConcreteMethod implements Method {
    ...
    private final com.droid.dx.cf.code.LineNumberList lineNumbers;

    /** {@code non-null;} local variable list */
    private final com.droid.dx.cf.code.LocalVariableList localVariables;
    ...
    public ConcreteMethod(Method method, int accessFlags, CstString sourceFile,
        ...
        this.method = method;
        this.accSuper = (accessFlags & com.droid.dx.rop.code.AccessFlags.ACC_SUPER) != 0;
         ...
         */
        com.droid.dx.cf.code.LineNumberList lineNumbers = com.droid.dx.cf.code.LineNumberList.EMPTY;
        if (keepLines) {
            for (AttLineNumberTable lnt = (AttLineNumberTable)
                ...
                lineNumbers = com.droid.dx.cf.code.LineNumberList.concat(lineNumbers,
                        lnt.getLineNumbers());
            }
        }
        this.lineNumbers = lineNumbers;

        com.droid.dx.cf.code.LocalVariableList localVariables = com.droid.dx.cf.code.LocalVariableList.EMPTY;
        if (keepLocals) {
            /*
            ...
            for (AttLocalVariableTable lvt = (AttLocalVariableTable)
                ...
                localVariables =
                    com.droid.dx.cf.code.LocalVariableList.concat(localVariables,
                            lvt.getLocalVariables());
            }

            com.droid.dx.cf.code.LocalVariableList typeList = com.droid.dx.cf.code.LocalVariableList.EMPTY;
            for (com.droid.dx.cf.attrib.AttLocalVariableTypeTable lvtt = (com.droid.dx.cf.attrib.AttLocalVariableTypeTable)
                     codeAttribs.findFirst(
                             com.droid.dx.cf.attrib.AttLocalVariableTypeTable.ATTRIBUTE_NAME);
                 lvtt != null;
                 lvtt =
                     (com.droid.dx.cf.attrib.AttLocalVariableTypeTable) codeAttribs.findNext(lvtt)) {
                typeList =
                    com.droid.dx.cf.code.LocalVariableList.concat(typeList,
                            lvtt.getLocalVariables());
            }

            if (typeList.size() != 0) {
                localVariables =
                    com.droid.dx.cf.code.LocalVariableList.mergeDescriptorsAndSignatures(
     ...
     */
    public com.droid.dx.cf.code.ByteCatchList getCatches() {
     ...
     */
    public com.droid.dx.cf.code.LineNumberList getLineNumbers() {
        return lineNumbers;
    }
     ...
     */
    public com.droid.dx.cf.code.LocalVariableList getLocalVariables() {
