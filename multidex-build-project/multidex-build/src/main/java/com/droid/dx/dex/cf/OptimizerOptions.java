...
public class OptimizerOptions {
     ...
     */
    public static void compareOptimizerStep(com.droid.dx.rop.code.RopMethod nonOptRmeth,
                                            int paramSize, boolean isStatic, CfOptions args,
                                            com.droid.dx.rop.code.TranslationAdvice advice, com.droid.dx.rop.code.RopMethod rmeth) {
        EnumSet<com.droid.dx.ssa.Optimizer.OptionalStep> steps;

        steps = EnumSet.allOf(com.droid.dx.ssa.Optimizer.OptionalStep.class);

        // This is the step to skip.
        steps.remove(com.droid.dx.ssa.Optimizer.OptionalStep.CONST_COLLECTOR);

        com.droid.dx.rop.code.RopMethod skipRopMethod
                = com.droid.dx.ssa.Optimizer.optimize(nonOptRmeth,
