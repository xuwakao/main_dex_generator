...
/**
 * Implementation of {@link com.droid.dx.util.AnnotatedOutput} which stores the written data
 * into a {@code byte[]}.
 *
...
public final class ByteArrayAnnotatedOutput
        implements com.droid.dx.util.AnnotatedOutput, ByteOutput {
    ...
    public void assertCursor(int expectedCursor) {
        if (cursor != expectedCursor) {
            throw new com.droid.dex.util.ExceptionWithContext("expected cursor " +
    ...
    public int writeUleb128(int value) {
        ...
        com.droid.dex.Leb128.writeUnsignedLeb128(this, value);
    ...
    public int writeSleb128(int value) {
        ...
        int cursorBefore = cursor;
        com.droid.dex.Leb128.writeSignedLeb128(this, value);
        return (cursor - cursorBefore);
    }

    /** {@inheritDoc} */
    public void write(com.droid.dx.util.ByteArray bytes) {
        int blen = bytes.size();
        int writeAt = cursor;
    ...
    public void writeAnnotationsTo(Writer out) throws IOException {
        ...
        com.droid.dx.util.TwoColumnOutput twoc = new com.droid.dx.util.TwoColumnOutput(out, width1, width2, "|");
        ...
        while ((leftAt < cursor) && (rightAt < rightSz)) {
            ...
            left.write(com.droid.dx.util.Hex.dump(data, start, end - start, start, hexCols, 6));
            right.write(text);
            twoc.flush();
            leftAt = end;
        }
        ...
        if (leftAt < cursor) {
            ...
            left.write(com.droid.dx.util.Hex.dump(data, leftAt, cursor - leftAt, leftAt,
                                hexCols, 6));
        }
