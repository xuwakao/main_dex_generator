 ...
 *
 * <p><b>Note:</b> As a {@link com.droid.dx.rop.type.TypeBearer}, this class bears the return type
 * of the method.</p>
 */
public abstract class CstBaseMethodRef
    ...
    public final Prototype getPrototype(boolean isStatic) {
        if (isStatic) {
            ...
            if (instancePrototype == null) {
                com.droid.dx.rop.type.Type thisType = getDefiningClass().getClassType();
     ...
     */
    public final com.droid.dx.rop.type.Type getType() {
