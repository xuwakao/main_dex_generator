 ...
 */
public final class ByteCatchList extends com.droid.dx.util.FixedSizeList {
    ...
    public void set(int n, int startPc, int endPc, int handlerPc,
            com.droid.dx.rop.cst.CstType exceptionClass) {
    ...
    private static boolean typeNotFound(Item item, Item[] arr, int count) {
        com.droid.dx.rop.cst.CstType type = item.getExceptionClass();

        for (int i = 0; i < count; i++) {
            com.droid.dx.rop.cst.CstType one = arr[i].getExceptionClass();
            if ((one == type) || (one == com.droid.dx.rop.cst.CstType.OBJECT)) {
                return false;
            }
        }
     ...
     */
    public com.droid.dx.util.IntList toTargetList(int noException) {
        if (noException < -1) {
        ...
        if (sz == 0) {
            if (hasDefault) {
                 ...
                 */
                return com.droid.dx.util.IntList.makeImmutable(noException);
            }
            /*
             * The list is empty and there isn't even a no-exception
             * address.
             */
            return com.droid.dx.util.IntList.EMPTY;
        }

        com.droid.dx.util.IntList result = new com.droid.dx.util.IntList(sz + (hasDefault ? 1 : 0));
     ...
     */
    public com.droid.dx.rop.type.TypeList toRopCatchList() {
        int sz = size();
        if (sz == 0) {
            return com.droid.dx.rop.type.StdTypeList.EMPTY;
        }

        com.droid.dx.rop.type.StdTypeList result = new com.droid.dx.rop.type.StdTypeList(sz);
    ...
    public static class Item {
        ...
        private final com.droid.dx.rop.cst.CstType exceptionClass;
         ...
         *
         * @return {@code non-null;} the exception class; {@link com.droid.dx.rop.cst.CstType#OBJECT}
         * if this entry handles all possible exceptions
         */
        public com.droid.dx.rop.cst.CstType getExceptionClass() {
            return (exceptionClass != null) ?
                exceptionClass : com.droid.dx.rop.cst.CstType.OBJECT;
        }
