...
import com.droid.dx.dex.file.MixedItemSection.SortType;
import com.droid.dx.rop.cst.Constant;
import com.droid.dx.rop.cst.CstBaseMethodRef;
import com.droid.dx.rop.cst.CstEnumRef;
...
public final class DexFile {
    ...
    private final com.droid.dx.dex.file.MixedItemSection wordData;
     ...
     */
    private final com.droid.dx.dex.file.MixedItemSection typeLists;
     ...
     * straightforward way. See {@link com.droid.dx.dex.file.MapItem#addMap} for more detail.
     */
    private final com.droid.dx.dex.file.MixedItemSection map;

    /** {@code non-null;} string data section */
    private final com.droid.dx.dex.file.MixedItemSection stringData;

    /** {@code non-null;} string identifiers section */
    private final com.droid.dx.dex.file.StringIdsSection stringIds;

    /** {@code non-null;} type identifiers section */
    private final com.droid.dx.dex.file.TypeIdsSection typeIds;
    ...
    private final com.droid.dx.dex.file.MethodIdsSection methodIds;

    /** {@code non-null;} class definitions section */
    private final com.droid.dx.dex.file.ClassDefsSection classDefs;

    /** {@code non-null;} class data section */
    private final com.droid.dx.dex.file.MixedItemSection classData;

    /** {@code non-null;} byte data section */
    private final com.droid.dx.dex.file.MixedItemSection byteData;
     ...
     * final output file
     */
    private final com.droid.dx.dex.file.Section[] sections;
    ...
    public DexFile(DexOptions dexOptions) {
        ...
        typeLists = new com.droid.dx.dex.file.MixedItemSection(null, this, 4, SortType.NONE);
        wordData = new com.droid.dx.dex.file.MixedItemSection("word_data", this, 4, SortType.TYPE);
        stringData =
            new com.droid.dx.dex.file.MixedItemSection("string_data", this, 1, SortType.INSTANCE);
        classData = new com.droid.dx.dex.file.MixedItemSection(null, this, 1, SortType.NONE);
        byteData = new com.droid.dx.dex.file.MixedItemSection("byte_data", this, 1, SortType.TYPE);
        stringIds = new com.droid.dx.dex.file.StringIdsSection(this);
        typeIds = new com.droid.dx.dex.file.TypeIdsSection(this);
        protoIds = new ProtoIdsSection(this);
        fieldIds = new FieldIdsSection(this);
        methodIds = new com.droid.dx.dex.file.MethodIdsSection(this);
        classDefs = new com.droid.dx.dex.file.ClassDefsSection(this);
        map = new com.droid.dx.dex.file.MixedItemSection("map", this, 4, SortType.NONE);

        /*
         * This is the list of sections in the order they appear in
         * the final output.
         */
        sections = new com.droid.dx.dex.file.Section[] {
    ...
    public void writeTo(OutputStream out, Writer humanOut, boolean verbose)
        ...
        com.droid.dx.util.ByteArrayAnnotatedOutput result = toDex0(annotate, verbose);
     ...
     *
     * <p>This is package-scope in order to allow
     * the various {@link com.droid.dx.dex.file.Item} instances to add items to the
     * instance.</p>
     *
     * @return {@code non-null;} the string data section
     */
    /*package*/ com.droid.dx.dex.file.MixedItemSection getStringData() {
        return stringData;
    }
     ...
     */
    /*package*/ com.droid.dx.dex.file.MixedItemSection getWordData() {
        return wordData;
    }
     ...
     * @return {@code non-null;} the word data section
     */
    /*package*/ com.droid.dx.dex.file.MixedItemSection getTypeLists() {
        return typeLists;
    }
     ...
     */
    /*package*/ com.droid.dx.dex.file.MixedItemSection getMap() {
        return map;
    }
     ...
     */
    /*package*/ com.droid.dx.dex.file.StringIdsSection getStringIds() {
        return stringIds;
    }
     ...
     */
    public com.droid.dx.dex.file.ClassDefsSection getClassDefs() {
        return classDefs;
    }
     ...
     */
    /*package*/ com.droid.dx.dex.file.MixedItemSection getClassData() {
        return classData;
    }
     ...
     */
    public com.droid.dx.dex.file.TypeIdsSection getTypeIds() {
        return typeIds;
    }
     ...
     */
    public com.droid.dx.dex.file.MethodIdsSection getMethodIds() {
        return methodIds;
    }
     ...
     */
    /*package*/ com.droid.dx.dex.file.MixedItemSection getByteData() {
        return byteData;
    }
     ...
     */
    /*package*/ com.droid.dx.dex.file.Section getFirstDataSection() {
        return wordData;
    }
     ...
     * @return {@code non-null;} the section
     */
    /*package*/ com.droid.dx.dex.file.Section getLastDataSection() {
        return map;
    }
    ...
    /*package*/ void internIfAppropriate(Constant cst) {
        if (cst instanceof com.droid.dx.rop.cst.CstString) {
            stringIds.intern((com.droid.dx.rop.cst.CstString) cst);
    ...
    /**
     * Gets the {@link com.droid.dx.dex.file.IndexedItem} corresponding to the given constant,
     ...
     */
    /*package*/ com.droid.dx.dex.file.IndexedItem findItemOrNull(Constant cst) {
        com.droid.dx.dex.file.IndexedItem item;
    ...
    /**
     * Returns the contents of this instance as a {@code .dex} file,
     * in a {@link com.droid.dx.util.ByteArrayAnnotatedOutput} instance.
     *
     * @param annotate whether or not to keep annotations
     * @param verbose if annotating, whether to be verbose
     * @return {@code non-null;} a {@code .dex} file for this instance
     */
    private com.droid.dx.util.ByteArrayAnnotatedOutput toDex0(boolean annotate,
                                                              boolean verbose) {
        /*
        ...
        for (int i = 0; i < count; i++) {
            com.droid.dx.dex.file.Section one = sections[i];
            ...
            try {
                if (one == map) {
                     ...
                     */
                    com.droid.dx.dex.file.MapItem.addMap(sections, map);
                    map.prepare();
                }

                if (one instanceof com.droid.dx.dex.file.MixedItemSection) {
                    /*
                     * Place the items of a MixedItemSection that just
                     * got placed.
                     */
                    ((com.droid.dx.dex.file.MixedItemSection) one).placeItems();
                }

                offset = placedAt + one.writeSize();
            } catch (RuntimeException ex) {
                throw com.droid.dex.util.ExceptionWithContext.withContext(ex,
        ...
        com.droid.dx.util.ByteArrayAnnotatedOutput out = new com.droid.dx.util.ByteArrayAnnotatedOutput(barr);
        ...
        for (int i = 0; i < count; i++) {
            try {
                ...
                if (zeroCount < 0) {
                    throw new com.droid.dex.util.ExceptionWithContext("excess write of " +
                            (-zeroCount));
                }
                out.writeZeroes(one.getFileOffset() - out.getCursor());
                one.writeTo(out);
            } catch (RuntimeException ex) {
                com.droid.dex.util.ExceptionWithContext ec;
                if (ex instanceof com.droid.dex.util.ExceptionWithContext) {
                    ec = (com.droid.dex.util.ExceptionWithContext) ex;
                } else {
                    ec = new com.droid.dex.util.ExceptionWithContext(ex);
                }
    ...
    public Statistics getStatistics() {
        ...
        for (com.droid.dx.dex.file.Section s : sections) {
            stats.addAll(s);
        }
