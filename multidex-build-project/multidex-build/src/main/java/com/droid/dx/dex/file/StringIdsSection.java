...
public final class StringIdsSection
     ...
     */
    private final TreeMap<com.droid.dx.rop.cst.CstString, StringIdItem> strings;
    ...
    public StringIdsSection(DexFile file) {
        ...
        strings = new TreeMap<com.droid.dx.rop.cst.CstString, StringIdItem>();
    }
    ...
    /** {@inheritDoc} */
    @Override
    public IndexedItem get(com.droid.dx.rop.cst.Constant cst) {
        if (cst == null) {
        ...
        IndexedItem result = strings.get((com.droid.dx.rop.cst.CstString) cst);
     ...
     */
    public void writeHeaderPart(com.droid.dx.util.AnnotatedOutput out) {
        throwIfNotPrepared();
        ...
        if (out.annotates()) {
            out.annotate(4, "string_ids_size: " + com.droid.dx.util.Hex.u4(sz));
            out.annotate(4, "string_ids_off:  " + com.droid.dx.util.Hex.u4(offset));
        }
    ...
    public StringIdItem intern(String string) {
        return intern(new StringIdItem(new com.droid.dx.rop.cst.CstString(string)));
    }
     ...
     * @return {@code non-null;} the interned string
     */
    public StringIdItem intern(com.droid.dx.rop.cst.CstString string) {
    ...
    public synchronized StringIdItem intern(StringIdItem string) {
        ...
        com.droid.dx.rop.cst.CstString value = string.getValue();
     ...
     */
    public synchronized void intern(com.droid.dx.rop.cst.CstNat nat) {
        intern(nat.getName());
     ...
     */
    public int indexOf(com.droid.dx.rop.cst.CstString string) {
        if (string == null) {
            throw new NullPointerException("string == null");
        }
