...
public abstract class CstInsn
    ...
    private final com.droid.dx.rop.cst.Constant cst;
    ...
    public CstInsn(Rop opcode, SourcePosition position, RegisterSpec result,
                   RegisterSpecList sources, com.droid.dx.rop.cst.Constant cst) {
     ...
     */
    public com.droid.dx.rop.cst.Constant getConstant() {
        return cst;
    }
