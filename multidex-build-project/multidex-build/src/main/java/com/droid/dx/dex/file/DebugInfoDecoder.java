...
import com.droid.dex.util.ByteArrayByteInput;
...
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_SET_EPILOGUE_BEGIN;
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_SET_FILE;
...
public class DebugInfoDecoder {
    ...
    DebugInfoDecoder(byte[] encoded, int codesize, int regSize,
                     boolean isStatic, com.droid.dx.rop.cst.CstMethodRef ref, DexFile file) {
        if (encoded == null) {
        ...
        try {
            idx = file.getStringIds().indexOf(new com.droid.dx.rop.cst.CstString("this"));
    ...
    private int readStringIndex(ByteInput bs) throws IOException {
        int offsetIndex = com.droid.dex.Leb128.readUnsignedLeb128(bs);
    ...
    private void decode0() throws IOException {
        ...
        line = com.droid.dex.Leb128.readUnsignedLeb128(bs);
        int szParams = com.droid.dex.Leb128.readUnsignedLeb128(bs);
        ...
        for (int i = 0; i < szParams; i++) {
            com.droid.dx.rop.type.Type paramType = params.getType(i);
            LocalEntry le;
        ...
        for (;;) {
            ...
            switch (opcode) {
                case DBG_START_LOCAL: {
                    int reg = com.droid.dex.Leb128.readUnsignedLeb128(bs);
                    int nameIdx = readStringIndex(bs);
                ...
                case DBG_ADVANCE_PC:
                    address += com.droid.dex.Leb128.readUnsignedLeb128(bs);
                break;

                case DBG_ADVANCE_LINE:
                    line += com.droid.dex.Leb128.readSignedLeb128(bs);
                break;
    ...
    public static void validateEncode(byte[] info, DexFile file,
                                      com.droid.dx.rop.cst.CstMethodRef ref, com.droid.dx.dex.code.DalvCode code, boolean isStatic) {
        com.droid.dx.dex.code.PositionList pl = code.getPositions();
        com.droid.dx.dex.code.LocalList ll = code.getLocals();
        com.droid.dx.dex.code.DalvInsnList insns = code.getInsns();
    ...
    private static void validateEncode0(byte[] info, int codeSize,
                                        int countRegisters, boolean isStatic, com.droid.dx.rop.cst.CstMethodRef ref,
                                        DexFile file, com.droid.dx.dex.code.PositionList pl, com.droid.dx.dex.code.LocalList ll) {
        ...
        for (PositionEntry entry : decodedEntries) {
            ...
            for (int i = pl.size() - 1; i >= 0; i--) {
                com.droid.dx.dex.code.PositionList.Entry ple = pl.get(i);
        ...
        for (int i = 0; i < origSz; i++) {
            com.droid.dx.dex.code.LocalList.Entry origEntry = ll.get(i);
