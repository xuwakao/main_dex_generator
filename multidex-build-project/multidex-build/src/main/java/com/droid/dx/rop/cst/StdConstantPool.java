...
public final class StdConstantPool
        extends com.droid.dx.util.MutabilityControl implements ConstantPool {
     ...
     * @return never
     * @throws com.droid.dex.util.ExceptionWithContext always thrown
     */
    private static Constant throwInvalid(int idx) {
        throw new com.droid.dex.util.ExceptionWithContext("invalid constant pool index " +
                                       Hex.u2(idx));
    }
}
