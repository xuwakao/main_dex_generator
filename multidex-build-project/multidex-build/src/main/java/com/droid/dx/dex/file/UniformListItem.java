 ...
 */
public final class UniformListItem<T extends com.droid.dx.dex.file.OffsettedItem>
        extends com.droid.dx.dex.file.OffsettedItem {
     ...
     */
    private static int getAlignment(List<? extends com.droid.dx.dex.file.OffsettedItem> items) {
        try {
     ...
     */
    private static int writeSize(List<? extends com.droid.dx.dex.file.OffsettedItem> items) {
        /*
         * This class assumes all included items are the same size,
         * an assumption which is verified in place0().
         */
        com.droid.dx.dex.file.OffsettedItem first = items.get(0);
    ...
    public void addContents(com.droid.dx.dex.file.DexFile file) {
        for (com.droid.dx.dex.file.OffsettedItem i : items) {
            i.addContents(file);
        }
    }
    ...
    /** {@inheritDoc} */
    @Override
    protected void place0(com.droid.dx.dex.file.Section addedTo, int offset) {
        offset += headerSize();
    ...
    /** {@inheritDoc} */
    @Override
    protected void writeTo0(com.droid.dx.dex.file.DexFile file, AnnotatedOutput out) {
        int size = items.size();
