...
package com.droid.dx.command.findusages;
...
public final class FindUsages {
    ...
    private final com.droid.dx.io.CodeReader codeReader = new com.droid.dx.io.CodeReader();
    private final PrintWriter out;

    private com.droid.dex.ClassDef currentClass;
    private com.droid.dex.ClassData.Method currentMethod;

    public FindUsages(final com.droid.dex.Dex dex, String declaredBy, String memberName, final PrintWriter out) {
        this.dex = dex;
        this.out = out;
        ...
        codeReader.setFieldVisitor(new com.droid.dx.io.CodeReader.Visitor() {
            public void visit(com.droid.dx.io.instructions.DecodedInstruction[] all,
                              com.droid.dx.io.instructions.DecodedInstruction one) {
                int fieldId = one.getIndex();
                if (fieldIds.contains(fieldId)) {
                    out.println(location() + ": field reference " + dex.fieldIds().get(fieldId)
                            + " (" + com.droid.dx.io.OpcodeInfo.getName(one.getOpcode()) + ")");
                }
            }
        });

        codeReader.setMethodVisitor(new com.droid.dx.io.CodeReader.Visitor() {
            public void visit(com.droid.dx.io.instructions.DecodedInstruction[] all, com.droid.dx.io.instructions.DecodedInstruction one) {
    ...
    public void findUsages() {
        ...
        for (com.droid.dex.ClassDef classDef : dex.classDefs()) {
            ...
            com.droid.dex.ClassData classData = dex.readClassData(classDef);
            for (com.droid.dex.ClassData.Field field : classData.allFields()) {
            ...
            for (com.droid.dex.ClassData.Method method : classData.allMethods()) {
     ...
     * declaringType}.
     */
    private Set<Integer> getFieldIds(com.droid.dex.Dex dex, Set<Integer> memberNameIndexes, int declaringType) {
     ...
     */
    private Set<Integer> getMethodIds(com.droid.dex.Dex dex, Set<Integer> memberNameIndexes, int declaringType) {
     ...
     */
    private Set<Integer> findAssignableTypes(com.droid.dex.Dex dex, int typeIndex) {
