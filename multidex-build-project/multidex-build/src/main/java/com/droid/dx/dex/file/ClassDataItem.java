...
public final class ClassDataItem extends OffsettedItem {
    ...
    private final ArrayList<com.droid.dx.dex.file.EncodedMethod> directMethods;

    /** {@code non-null;} list of virtual methods */
    private final ArrayList<com.droid.dx.dex.file.EncodedMethod> virtualMethods;
    ...
    public ClassDataItem(CstType thisClass) {
        ...
        this.directMethods = new ArrayList<com.droid.dx.dex.file.EncodedMethod>(20);
        this.virtualMethods = new ArrayList<com.droid.dx.dex.file.EncodedMethod>(20);
    ...
    public ArrayList<com.droid.dx.dex.file.EncodedMethod> getMethods() {
        ...
        ArrayList<com.droid.dx.dex.file.EncodedMethod> result = new ArrayList<com.droid.dx.dex.file.EncodedMethod>(sz);
    ...
    public void addContents(DexFile file) {
        ...
        if (!directMethods.isEmpty()) {
            ...
            for (com.droid.dx.dex.file.EncodedMethod method : directMethods) {
        ...
        if (!virtualMethods.isEmpty()) {
            ...
            for (com.droid.dx.dex.file.EncodedMethod method : virtualMethods) {
                method.addContents(file);
            }
        }
    }
    ...
    private CstArray makeStaticValuesConstant() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            Constant cst = staticValues.get(field);
            if (cst == null) {
                cst = com.droid.dx.rop.cst.Zeroes.zeroFor(field.getRef().getType());
            }
            list.set(i, cst);
        }
        list.setImmutable();
    ...
    protected void place0(Section addedTo, int offset) {
        ...
        com.droid.dx.util.ByteArrayAnnotatedOutput out = new com.droid.dx.util.ByteArrayAnnotatedOutput();
    ...
    private static void encodeList(DexFile file, AnnotatedOutput out,
            String label, ArrayList<? extends com.droid.dx.dex.file.EncodedMember> list) {
        int size = list.size();
        int lastIndex = 0;
