...
public final class AttConstantValue extends BaseAttribute {
    ...
    public AttConstantValue(TypedConstant constantValue) {
        ...
        if (!((constantValue instanceof com.droid.dx.rop.cst.CstString) ||
               (constantValue instanceof com.droid.dx.rop.cst.CstInteger) ||
               (constantValue instanceof com.droid.dx.rop.cst.CstLong) ||
               (constantValue instanceof com.droid.dx.rop.cst.CstFloat) ||
               (constantValue instanceof com.droid.dx.rop.cst.CstDouble))) {
