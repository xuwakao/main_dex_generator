 ...
 * TypeBearer}.</p>
 */
public final class ExecutionStack extends com.droid.dx.util.MutabilityControl {
     ...
     * @throws com.droid.dx.cf.code.SimException thrown if there is insufficient room on the
     * stack for the value
     */
     ...
     * @throws com.droid.dx.cf.code.SimException thrown if {@code n >= size()}
     */
    ...
    public boolean peekLocal(int n) {
        ...
        if (n >= stackPtr) {
            throw new com.droid.dx.cf.code.SimException("stack: underflow");
        }
     ...
     * @throws com.droid.dx.cf.code.SimException thrown if the stack is empty
     */
     ...
     * @throws com.droid.dx.cf.code.SimException thrown if {@code n >= size()} or
    ...
    public ExecutionStack merge(ExecutionStack other) {
        ...
        } catch (com.droid.dx.cf.code.SimException ex) {
    ...
    private static TypeBearer throwSimException(String msg) {
        throw new com.droid.dx.cf.code.SimException("stack: " + msg);
    }
}
