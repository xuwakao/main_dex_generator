...
public final class EncodedMethod extends EncodedMember
     ...
     */
    public EncodedMethod(com.droid.dx.rop.cst.CstMethodRef method, int accessFlags,
                         com.droid.dx.dex.code.DalvCode code, com.droid.dx.rop.type.TypeList throwsList) {
        super(accessFlags);
        ...
        if (code == null) {
            ...
            boolean isStatic = (accessFlags & com.droid.dx.rop.code.AccessFlags.ACC_STATIC) != 0;
    ...
    public String toString() {
        ...
        sb.append('{');
        sb.append(com.droid.dx.util.Hex.u2(getAccessFlags()));
        sb.append(' ');
        sb.append(method);
    ...
    /** {@inheritDoc} */
    @Override
    public final com.droid.dx.rop.cst.CstString getName() {
     ...
     */
    public final com.droid.dx.rop.cst.CstMethodRef getRef() {
        return method;
    }

    /** {@inheritDoc} */
    @Override
    public int encode(DexFile file, com.droid.dx.util.AnnotatedOutput out,
        ...
        boolean shouldHaveCode = (accessFlags &
                (com.droid.dx.rop.code.AccessFlags.ACC_ABSTRACT | com.droid.dx.rop.code.AccessFlags.ACC_NATIVE)) == 0;
        ...
        if (out.annotates()) {
            out.annotate(0, String.format("  [%x] %s", dumpSeq,
                            method.toHuman()));
            out.annotate(com.droid.dex.Leb128.unsignedLeb128Size(diff),
                    "    method_idx:   " + com.droid.dx.util.Hex.u4(methodIdx));
            out.annotate(com.droid.dex.Leb128.unsignedLeb128Size(accessFlags),
                    "    access_flags: " +
                    com.droid.dx.rop.code.AccessFlags.methodString(accessFlags));
            out.annotate(com.droid.dex.Leb128.unsignedLeb128Size(codeOff),
                    "    code_off:     " + com.droid.dx.util.Hex.u4(codeOff));
        }
