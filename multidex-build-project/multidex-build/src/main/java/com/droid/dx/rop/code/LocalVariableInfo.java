...
import com.droid.dx.util.MutabilityControl;
...
public final class LocalVariableInfo
    ...
    /**
     * {@code non-null;} {@link com.droid.dx.rop.code.RegisterSpecSet} to use when indicating a block
     * that has no locals; it is empty and immutable but has an appropriate
     * max size for the method
     */
    private final com.droid.dx.rop.code.RegisterSpecSet emptySet;
     ...
     */
    private final com.droid.dx.rop.code.RegisterSpecSet[] blockStarts;

    /** {@code non-null;} map from instructions to the variable each assigns */
    private final HashMap<com.droid.dx.rop.code.Insn, com.droid.dx.rop.code.RegisterSpec> insnAssignments;
    ...
    public LocalVariableInfo(RopMethod method) {
        ...
        com.droid.dx.rop.code.BasicBlockList blocks = method.getBlocks();
        int maxLabel = blocks.getMaxLabel();

        this.regCount = blocks.getRegCount();
        this.emptySet = new com.droid.dx.rop.code.RegisterSpecSet(regCount);
        this.blockStarts = new com.droid.dx.rop.code.RegisterSpecSet[maxLabel];
        this.insnAssignments =
            new HashMap<com.droid.dx.rop.code.Insn, com.droid.dx.rop.code.RegisterSpec>(blocks.getInstructionCount());
     ...
     */
    public void setStarts(int label, com.droid.dx.rop.code.RegisterSpecSet specs) {
        throwIfImmutable();
     ...
     */
    public boolean mergeStarts(int label, com.droid.dx.rop.code.RegisterSpecSet specs) {
        com.droid.dx.rop.code.RegisterSpecSet start = getStarts0(label);
        ...
        com.droid.dx.rop.code.RegisterSpecSet newStart = start.mutableCopy();
        if (start.size() != 0) {
     ...
     */
    public com.droid.dx.rop.code.RegisterSpecSet getStarts(int label) {
        com.droid.dx.rop.code.RegisterSpecSet result = getStarts0(label);
     ...
     * @return {@code non-null;} the associated register set
     */
    public com.droid.dx.rop.code.RegisterSpecSet getStarts(com.droid.dx.rop.code.BasicBlock block) {
     ...
     * newly-allocated empty {@link com.droid.dx.rop.code.RegisterSpecSet} of appropriate
     * max size if there is not yet any set associated with the block.
     *
     * @param label {@code >= 0;} the block label
     * @return {@code non-null;} the associated register set
     */
    public com.droid.dx.rop.code.RegisterSpecSet mutableCopyOfStarts(int label) {
        com.droid.dx.rop.code.RegisterSpecSet result = getStarts0(label);

        return (result != null) ?
            result.mutableCopy() : new com.droid.dx.rop.code.RegisterSpecSet(regCount);
    }
     ...
     */
    public void addAssignment(com.droid.dx.rop.code.Insn insn, com.droid.dx.rop.code.RegisterSpec spec) {
        throwIfImmutable();
     ...
     */
    public com.droid.dx.rop.code.RegisterSpec getAssignment(com.droid.dx.rop.code.Insn insn) {
     ...
     * is none
     */
    private com.droid.dx.rop.code.RegisterSpecSet getStarts0(int label) {
        try {
