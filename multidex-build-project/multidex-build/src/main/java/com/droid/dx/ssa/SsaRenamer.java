...
public class SsaRenamer implements Runnable {
    ...
    private final ArrayList<com.droid.dx.rop.code.LocalItem> ssaRegToLocalItems;
    ...
    public SsaRenamer(SsaMethod ssaMeth) {
        ...
        ssaRegToLocalItems = new ArrayList<com.droid.dx.rop.code.LocalItem>();
   ...
   public SsaRenamer(SsaMethod ssaMeth, int thresh) {
     ...
     */
    private com.droid.dx.rop.code.LocalItem getLocalForNewReg(int ssaReg) {
    ...
    private void setNameForSsaReg(RegisterSpec ssaReg) {
        ...
        com.droid.dx.rop.code.LocalItem local = ssaReg.getLocalItem();
     ...
     * as appropriate.
     */
    private class BlockRenamer implements com.droid.dx.ssa.SsaInsn.Visitor {
         ...
         */
        private final HashSet<com.droid.dx.ssa.SsaInsn> movesToKeep;

        /**
         * maps the set of insns to replace after renaming is finished
         * on the block.
         */
        private final HashMap<com.droid.dx.ssa.SsaInsn, com.droid.dx.ssa.SsaInsn> insnsToReplace;
        ...
        BlockRenamer(final SsaBasicBlock block) {
            ...
            movesToKeep = new HashSet<com.droid.dx.ssa.SsaInsn>();
            insnsToReplace = new HashMap<com.droid.dx.ssa.SsaInsn, com.droid.dx.ssa.SsaInsn>();
         ...
         */
        private class RenamingMapper extends com.droid.dx.ssa.RegisterMapper {
        ...
        public void process() {
            ...
            for (int i = szInsns - 1; i >= 0 ; i--) {
                ...
                com.droid.dx.ssa.SsaInsn replaceInsn;
        ...
        private void addMapping(int ropReg, RegisterSpec ssaReg) {
            ...
            com.droid.dx.rop.code.LocalItem ssaRegLocal = ssaReg.getLocalItem();
        ...
        public void visitMoveInsn(com.droid.dx.ssa.NormalSsaInsn insn) {
            ...
            com.droid.dx.rop.code.LocalItem sourceLocal
                = currentMapping[ropSourceReg].getLocalItem();
            com.droid.dx.rop.code.LocalItem resultLocal = ropResult.getLocalItem();
            ...
            com.droid.dx.rop.code.LocalItem newLocal
                = (resultLocal == null) ? sourceLocal : resultLocal;
            com.droid.dx.rop.code.LocalItem associatedLocal = getLocalForNewReg(ssaSourceReg);
            ...
            if (!com.droid.dx.ssa.Optimizer.getPreserveLocals() || (onlyOneAssociatedLocal
                ...
                com.droid.dx.ssa.SsaInsn newInsn
                        = com.droid.dx.ssa.SsaInsn.makeFromRop(
         ...
         */
        void processResultReg(com.droid.dx.ssa.SsaInsn insn) {
            RegisterSpec ropResult = insn.getResult();
        ...
        private void updateSuccessorPhis() {
            com.droid.dx.ssa.PhiInsn.Visitor visitor = new com.droid.dx.ssa.PhiInsn.Visitor() {
