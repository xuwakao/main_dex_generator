...
import com.droid.dx.cf.iface.StdField;
...
final /*package*/ class FieldListParser extends MemberListParser {
    ...
    private final com.droid.dx.cf.iface.StdFieldList fields;
    ...
    public FieldListParser(DirectClassFile cf, CstType definer, int offset,
        ...
        fields = new com.droid.dx.cf.iface.StdFieldList(getCount());
    }
     ...
     */
    public com.droid.dx.cf.iface.StdFieldList getList() {
        parseIfNecessary();
        return fields;
    }
    ...
    protected String humanAccessFlags(int accessFlags) {
        return com.droid.dx.rop.code.AccessFlags.fieldString(accessFlags);
    }
