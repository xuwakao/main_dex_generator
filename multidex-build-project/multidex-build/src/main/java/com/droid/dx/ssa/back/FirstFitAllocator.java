...
public class FirstFitAllocator extends RegisterAllocator {
    ...
    public FirstFitAllocator(
            final com.droid.dx.ssa.SsaMethod ssaMeth, final InterferenceGraph interference) {
    ...
    public com.droid.dx.ssa.RegisterMapper allocateRegisters() {
        ...
        com.droid.dx.ssa.BasicRegisterMapper mapper
                = new com.droid.dx.ssa.BasicRegisterMapper(oldRegCount);
        ...
        for (int i = 0; i < oldRegCount; i++) {
            ...
            com.droid.dx.util.IntSet current = new com.droid.dx.util.BitIntSet(oldRegCount);
            ...
            if (PRESLOT_PARAMS && isDefinitionMoveParam(i)) {
                ...
                com.droid.dx.ssa.NormalSsaInsn defInsn = (com.droid.dx.ssa.NormalSsaInsn)
     ...
     */
    private int paramNumberFromMoveParam(com.droid.dx.ssa.NormalSsaInsn ndefInsn) {
