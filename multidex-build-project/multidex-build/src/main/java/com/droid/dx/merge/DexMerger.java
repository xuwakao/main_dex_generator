...
import com.droid.dex.ClassData;
import com.droid.dex.ClassDef;
import com.droid.dex.Code;
import com.droid.dex.DexException;
import com.droid.dex.DexIndexOverflowException;
import com.droid.dex.FieldId;
import com.droid.dex.MethodId;
import com.droid.dex.ProtoId;
import com.droid.dex.SizeOf;
import com.droid.dex.TypeList;
...
public final class DexMerger {
    private final com.droid.dex.Dex[] dexes;
    private final com.droid.dx.merge.IndexMap[] indexMaps;

    private final com.droid.dx.merge.CollisionPolicy collisionPolicy;
    private final WriterSizes writerSizes;

    private final com.droid.dex.Dex dexOut;

    private final com.droid.dex.Dex.Section headerOut;

    /** All IDs and definitions sections */
    private final com.droid.dex.Dex.Section idsDefsOut;

    private final com.droid.dex.Dex.Section mapListOut;

    private final com.droid.dex.Dex.Section typeListOut;

    private final com.droid.dex.Dex.Section classDataOut;

    private final com.droid.dex.Dex.Section codeOut;

    private final com.droid.dex.Dex.Section stringDataOut;

    private final com.droid.dex.Dex.Section debugInfoOut;

    private final com.droid.dex.Dex.Section encodedArrayOut;

    /** annotations directory on a type */
    private final com.droid.dex.Dex.Section annotationsDirectoryOut;

    /** sets of annotations on a member, parameter or type */
    private final com.droid.dex.Dex.Section annotationSetOut;

    /** parameter lists */
    private final com.droid.dex.Dex.Section annotationSetRefListOut;

    /** individual annotations, each containing zero or more fields */
    private final com.droid.dex.Dex.Section annotationOut;

    private final com.droid.dex.TableOfContents contentsOut;
    ...
    public DexMerger(com.droid.dex.Dex[] dexes, com.droid.dx.merge.CollisionPolicy collisionPolicy)
            throws IOException {
        this(dexes, collisionPolicy, new WriterSizes(dexes));
    }

    private DexMerger(com.droid.dex.Dex[] dexes, com.droid.dx.merge.CollisionPolicy collisionPolicy,
                      WriterSizes writerSizes) throws IOException {
        this.dexes = dexes;
        this.collisionPolicy = collisionPolicy;
        this.writerSizes = writerSizes;

        dexOut = new com.droid.dex.Dex(writerSizes.size());

        indexMaps = new com.droid.dx.merge.IndexMap[dexes.length];
        for (int i = 0; i < dexes.length; i++) {
            indexMaps[i] = new com.droid.dx.merge.IndexMap(dexOut, dexes[i].getTableOfContents());
        }
    ...
    private com.droid.dex.Dex mergeDexes() throws IOException {
        mergeStringIds();
        mergeTypeIds();
        mergeTypeLists();
        mergeProtoIds();
    ...
    public com.droid.dex.Dex merge() throws IOException {
        if (dexes.length == 1) {
            return dexes[0];
        ...
        com.droid.dex.Dex result = mergeDexes();
        ...
        if (wastedByteCount >  + compactWasteThreshold) {
            DexMerger compacter = new DexMerger(
                    new com.droid.dex.Dex[] {dexOut, new com.droid.dex.Dex(0)}, com.droid.dx.merge.CollisionPolicy.FAIL, compactedSizes);
    ...
    abstract class IdMerger<T extends Comparable<T>> {
        private final com.droid.dex.Dex.Section out;

        protected IdMerger(com.droid.dex.Dex.Section out) {
            this.out = out;
        }
        ...
        public final void mergeSorted() {
            com.droid.dex.TableOfContents.Section[] sections = new com.droid.dex.TableOfContents.Section[dexes.length];
            com.droid.dex.Dex.Section[] dexSections = new com.droid.dex.Dex.Section[dexes.length];
        ...
        private int readIntoMap(com.droid.dex.Dex.Section in, com.droid.dex.TableOfContents.Section section, com.droid.dx.merge.IndexMap indexMap,
        ...
        private List<UnsortedValue> readUnsortedValues(com.droid.dex.Dex source, com.droid.dx.merge.IndexMap indexMap) {
            com.droid.dex.TableOfContents.Section section = getSection(source.getTableOfContents());
            if (!section.exists()) {
                return Collections.emptyList();
            }

            List<UnsortedValue> result = new ArrayList<UnsortedValue>();
            com.droid.dex.Dex.Section in = source.open(section.off);
        ...
        abstract com.droid.dex.TableOfContents.Section getSection(com.droid.dex.TableOfContents tableOfContents);
        abstract T read(com.droid.dex.Dex.Section in, com.droid.dx.merge.IndexMap indexMap, int index);
        abstract void updateIndex(int offset, com.droid.dx.merge.IndexMap indexMap, int oldIndex, int newIndex);
        abstract void write(T value);

        class UnsortedValue implements Comparable<UnsortedValue> {
            final com.droid.dex.Dex source;
            final com.droid.dx.merge.IndexMap indexMap;
            final T value;
            final int index;
            final int offset;

            UnsortedValue(com.droid.dex.Dex source, com.droid.dx.merge.IndexMap indexMap, T value, int index, int offset) {
                this.source = source;
    ...
    private void mergeStringIds() {
        new IdMerger<String>(idsDefsOut) {
            @Override
            com.droid.dex.TableOfContents.Section getSection(com.droid.dex.TableOfContents tableOfContents) {
                return tableOfContents.stringIds;
            }

            @Override String read(com.droid.dex.Dex.Section in, com.droid.dx.merge.IndexMap indexMap, int index) {
                return in.readString();
            }

            @Override void updateIndex(int offset, com.droid.dx.merge.IndexMap indexMap, int oldIndex, int newIndex) {
    ...
    private void mergeTypeIds() {
        new IdMerger<Integer>(idsDefsOut) {
            ...
            @Override Integer read(com.droid.dex.Dex.Section in, com.droid.dx.merge.IndexMap indexMap, int index) {
    ...
    private void mergeTypeLists() {
        new IdMerger<TypeList>(typeListOut) {
            ...
            @Override TypeList read(com.droid.dex.Dex.Section in, com.droid.dx.merge.IndexMap indexMap, int index) {
    ...
    private void mergeProtoIds() {
        new IdMerger<ProtoId>(idsDefsOut) {
            ...
            @Override ProtoId read(com.droid.dex.Dex.Section in, com.droid.dx.merge.IndexMap indexMap, int index) {
    ...
    private void mergeFieldIds() {
        new IdMerger<FieldId>(idsDefsOut) {
            ...
            @Override FieldId read(com.droid.dex.Dex.Section in, com.droid.dx.merge.IndexMap indexMap, int index) {
    ...
    private void mergeMethodIds() {
        new IdMerger<MethodId>(idsDefsOut) {
            ...
            @Override MethodId read(com.droid.dex.Dex.Section in, com.droid.dx.merge.IndexMap indexMap, int index) {
    ...
    private void mergeAnnotations() {
        new IdMerger<com.droid.dex.Annotation>(annotationOut) {
            @Override
            com.droid.dex.TableOfContents.Section getSection(com.droid.dex.TableOfContents tableOfContents) {
            ...
            @Override
            com.droid.dex.Annotation read(com.droid.dex.Dex.Section in, com.droid.dx.merge.IndexMap indexMap, int index) {
            ...
            @Override void write(com.droid.dex.Annotation value) {
    ...
    private void mergeClassDefs() {
        com.droid.dx.merge.SortableType[] types = getSortedTypes();
        contentsOut.classDefs.off = idsDefsOut.getPosition();
        contentsOut.classDefs.size = types.length;

        for (com.droid.dx.merge.SortableType type : types) {
            com.droid.dex.Dex in = type.getDex();
     ...
     */
    private com.droid.dx.merge.SortableType[] getSortedTypes() {
        // size is pessimistic; doesn't include arrays
        com.droid.dx.merge.SortableType[] sortableTypes = new com.droid.dx.merge.SortableType[contentsOut.typeIds.size];
        for (int i = 0; i < dexes.length; i++) {
        ...
        while (true) {
            ...
            for (com.droid.dx.merge.SortableType sortableType : sortableTypes) {
        ...
        Arrays.sort(sortableTypes, com.droid.dx.merge.SortableType.NULLS_LAST_ORDER);
     ...
     * it later.
     */
    private void readSortableTypes(com.droid.dx.merge.SortableType[] sortableTypes, com.droid.dex.Dex buffer,
                                   com.droid.dx.merge.IndexMap indexMap) {
        for (ClassDef classDef : buffer.classDefs()) {
            com.droid.dx.merge.SortableType sortableType = indexMap.adjust(
                    new com.droid.dx.merge.SortableType(buffer, indexMap, classDef));
            int t = sortableType.getTypeIndex();
            if (sortableTypes[t] == null) {
                sortableTypes[t] = sortableType;
            } else if (collisionPolicy != com.droid.dx.merge.CollisionPolicy.KEEP_FIRST) {
    ...
    private void transformAnnotationSets(com.droid.dex.Dex in, com.droid.dx.merge.IndexMap indexMap) {
        com.droid.dex.TableOfContents.Section section = in.getTableOfContents().annotationSets;
        if (section.exists()) {
            com.droid.dex.Dex.Section setIn = in.open(section.off);
            for (int i = 0; i < section.size; i++) {
    ...
    private void transformAnnotationSetRefLists(com.droid.dex.Dex in, com.droid.dx.merge.IndexMap indexMap) {
        com.droid.dex.TableOfContents.Section section = in.getTableOfContents().annotationSetRefLists;
        if (section.exists()) {
            com.droid.dex.Dex.Section setIn = in.open(section.off);
            for (int i = 0; i < section.size; i++) {
    ...
    private void transformAnnotationDirectories(com.droid.dex.Dex in, com.droid.dx.merge.IndexMap indexMap) {
        com.droid.dex.TableOfContents.Section section = in.getTableOfContents().annotationsDirectories;
        if (section.exists()) {
            com.droid.dex.Dex.Section directoryIn = in.open(section.off);
            for (int i = 0; i < section.size; i++) {
    ...
    private void transformStaticValues(com.droid.dex.Dex in, com.droid.dx.merge.IndexMap indexMap) {
        com.droid.dex.TableOfContents.Section section = in.getTableOfContents().encodedArrays;
        if (section.exists()) {
            com.droid.dex.Dex.Section staticValuesIn = in.open(section.off);
            for (int i = 0; i < section.size; i++) {
     ...
     * data.
     */
    private void transformClassDef(com.droid.dex.Dex in, ClassDef classDef, com.droid.dx.merge.IndexMap indexMap) {
    ...
    private void transformAnnotationDirectory(
            com.droid.dex.Dex.Section directoryIn, com.droid.dx.merge.IndexMap indexMap) {
     ...
     */
    private void transformAnnotationSet(com.droid.dx.merge.IndexMap indexMap, com.droid.dex.Dex.Section setIn) {
     ...
     */
    private void transformAnnotationSetRefList(com.droid.dx.merge.IndexMap indexMap, com.droid.dex.Dex.Section refListIn) {
    ...
    private void transformClassData(com.droid.dex.Dex in, ClassData classData, com.droid.dx.merge.IndexMap indexMap) {
    ...
    private void transformFields(com.droid.dx.merge.IndexMap indexMap, ClassData.Field[] fields) {
    ...
    private void transformMethods(com.droid.dex.Dex in, com.droid.dx.merge.IndexMap indexMap, ClassData.Method[] methods) {
    ...
    private void transformCode(com.droid.dex.Dex in, Code code, com.droid.dx.merge.IndexMap indexMap) {
        ...
        if (tries.length > 0) {
             ...
             */
            com.droid.dex.Dex.Section triesSection = dexOut.open(codeOut.getPosition());
     ...
     */
    private int[] transformCatchHandlers(com.droid.dx.merge.IndexMap indexMap, Code.CatchHandler[] catchHandlers) {
    ...
    private void transformTries(com.droid.dex.Dex.Section out, Code.Try[] tries,
    ...
    private void transformDebugInfoItem(com.droid.dex.Dex.Section in, com.droid.dx.merge.IndexMap indexMap) {
    ...
    private void transformEncodedCatchHandler(Code.CatchHandler catchHandler, com.droid.dx.merge.IndexMap indexMap) {
    ...
    private void transformStaticValues(com.droid.dex.Dex.Section in, com.droid.dx.merge.IndexMap indexMap) {
    ...
    private static class WriterSizes {
         ...
         */
        public WriterSizes(com.droid.dex.Dex[] dexes) {
            for (int i = 0; i < dexes.length; i++) {
        ...
        private void plus(com.droid.dex.TableOfContents contents, boolean exact) {
    ...
    public static void main(String[] args) throws IOException {
        ...
        com.droid.dex.Dex[] dexes = new com.droid.dex.Dex[args.length - 1];
        for (int i = 1; i < args.length; i++) {
            dexes[i - 1] = new com.droid.dex.Dex(new File(args[i]));
        }
        com.droid.dex.Dex merged = new DexMerger(dexes, com.droid.dx.merge.CollisionPolicy.KEEP_FIRST).merge();
