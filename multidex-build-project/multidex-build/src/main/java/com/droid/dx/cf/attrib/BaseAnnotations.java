...
public abstract class BaseAnnotations extends BaseAttribute {
    ...
    private final com.droid.dx.rop.annotation.Annotations annotations;
     ...
     */
    public BaseAnnotations(String attributeName, com.droid.dx.rop.annotation.Annotations annotations,
            int byteLength) {
        super(attributeName);

        try {
            if (annotations.isMutable()) {
                throw new com.droid.dx.util.MutabilityException("annotations.isMutable()");
            }
     ...
     */
    public final com.droid.dx.rop.annotation.Annotations getAnnotations() {
        return annotations;
    }
}
