...
import com.droid.dx.util.IndentingWriter;
...
/**
 * List of {@link com.droid.dx.dex.code.DalvInsn} instances.
 */
public final class DalvInsnList extends FixedSizeList {
     ...
     * class
     */
    public static DalvInsnList makeImmutable(ArrayList<com.droid.dx.dex.code.DalvInsn> list,
            int regCount) {
        int size = list.size();
     ...
     */
    public com.droid.dx.dex.code.DalvInsn get(int n) {
        return (com.droid.dx.dex.code.DalvInsn) get0(n);
    }
     ...
     */
    public void set(int n, com.droid.dx.dex.code.DalvInsn insn) {
        set0(n, insn);
    }
    ...
    public int codeSize() {
        ...
        com.droid.dx.dex.code.DalvInsn last = get(sz - 1);
    ...
    public void writeTo(AnnotatedOutput out) {
        ...
        if (out.annotates()) {
            ...
            for (int i = 0; i < sz; i++) {
                com.droid.dx.dex.code.DalvInsn insn = (com.droid.dx.dex.code.DalvInsn) get0(i);
