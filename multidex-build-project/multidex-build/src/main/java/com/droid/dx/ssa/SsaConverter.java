...
public class SsaConverter {
     ...
     */
    public static SsaMethod convertToSsaMethod(com.droid.dx.rop.code.RopMethod rmeth,
        ...
        com.droid.dx.ssa.LocalVariableInfo localInfo = LocalVariableExtractor.extract(result);
    ...
    public static void updateSsaMethod(SsaMethod ssaMeth, int threshold) {
        com.droid.dx.ssa.LocalVariableInfo localInfo = LocalVariableExtractor.extract(ssaMeth);
     ...
     */
    public static SsaMethod testEdgeSplit (com.droid.dx.rop.code.RopMethod rmeth, int paramWidth,
                                           boolean isStatic) {
        SsaMethod result;
     ...
     * @return an SSA represention with only the edge-splitter run
     */
    public static SsaMethod testPhiPlacement (com.droid.dx.rop.code.RopMethod rmeth, int paramWidth,
                                              boolean isStatic) {
        SsaMethod result;
    ...
    private static boolean needsNewSuccessor(SsaBasicBlock block,
        ...
        com.droid.dx.ssa.SsaInsn lastInsn = insns.get(insns.size() - 1);
    ...
    private static void placePhiFunctions (SsaMethod ssaMeth,
                                           com.droid.dx.ssa.LocalVariableInfo localInfo, int threshold) {
        ...
        com.droid.dx.ssa.DomFront df = new com.droid.dx.ssa.DomFront(ssaMeth);
        com.droid.dx.ssa.DomFront.DomInfo[] domInfos = df.run();
        ...
        for (int bi = 0, s = ssaBlocks.size(); bi < s; bi++) {
            ...
            for (com.droid.dx.ssa.SsaInsn insn : b.getInsns()) {
