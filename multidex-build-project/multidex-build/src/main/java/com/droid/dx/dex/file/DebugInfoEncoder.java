...
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_ADVANCE_LINE;
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_ADVANCE_PC;
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_END_LOCAL;
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_END_SEQUENCE;
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_FIRST_SPECIAL;
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_LINE_BASE;
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_LINE_RANGE;
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_RESTART_LOCAL;
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_SET_PROLOGUE_END;
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_START_LOCAL;
import static com.droid.dx.dex.file.DebugInfoConstants.DBG_START_LOCAL_EXTENDED;
...
public final class DebugInfoEncoder {
    ...
    private final com.droid.dx.dex.code.PositionList positions;

    /** {@code null-ok;} local variables to encode */
    private final com.droid.dx.dex.code.LocalList locals;

    private final com.droid.dx.util.ByteArrayAnnotatedOutput output;
     ...
     */
    private com.droid.dx.util.AnnotatedOutput annotateTo;
    ...
    private final com.droid.dx.dex.code.LocalList.Entry[] lastEntryForReg;
     ...
     * @param ref
     */
    public DebugInfoEncoder(com.droid.dx.dex.code.PositionList positions, com.droid.dx.dex.code.LocalList locals,
                            DexFile file, int codeSize, int regSize,
                            boolean isStatic, com.droid.dx.rop.cst.CstMethodRef ref) {
        ...
        output = new com.droid.dx.util.ByteArrayAnnotatedOutput();
        lastEntryForReg = new com.droid.dx.dex.code.LocalList.Entry[regSize];
    }
    ...
    public byte[] convert() {
        try {
            ...
            throw com.droid.dex.util.ExceptionWithContext
    ...
    public byte[] convertAndAnnotate(String prefix, PrintWriter debugPrint,
                                     com.droid.dx.util.AnnotatedOutput out, boolean consume) {
        this.prefix = prefix;
    ...
    private byte[] convert0() throws IOException {
        ArrayList<com.droid.dx.dex.code.PositionList.Entry> sortedPositions = buildSortedPositions();
        ArrayList<com.droid.dx.dex.code.LocalList.Entry> methodArgs = extractMethodArguments();
    ...
    private int emitLocalsAtAddress(int curLocalIdx)
        ...
        while ((curLocalIdx < sz)
            ...
            com.droid.dx.dex.code.LocalList.Entry entry = locals.get(curLocalIdx++);
            int reg = entry.getRegister();
            com.droid.dx.dex.code.LocalList.Entry prevEntry = lastEntryForReg[reg];
            ...
            if (entry.isStart()) {
                ...
                if (entry.getDisposition()
                        != com.droid.dx.dex.code.LocalList.Disposition.END_REPLACED) {
                    emitLocalEnd(entry);
                }
            }
        }
    ...
    private int emitPositionsAtAddress(int curPositionIdx,
            ArrayList<com.droid.dx.dex.code.PositionList.Entry> sortedPositions)
            throws IOException {
        int positionsSz = sortedPositions.size();
     ...
     * @throws IOException
     */
    private void emitHeader(ArrayList<com.droid.dx.dex.code.PositionList.Entry> sortedPositions,
            ArrayList<com.droid.dx.dex.code.LocalList.Entry> methodArgs) throws IOException {
        ...
        if (sortedPositions.size() > 0) {
            com.droid.dx.dex.code.PositionList.Entry entry = sortedPositions.get(0);
        ...
        com.droid.dx.rop.type.StdTypeList paramTypes = desc.getParameterTypes();
         ...
         */
        if (!isStatic) {
            for (com.droid.dx.dex.code.LocalList.Entry arg : methodArgs) {
        ...
        for (int i = 0; i < szParamTypes; i++) {
            com.droid.dx.rop.type.Type pt = paramTypes.get(i);
            com.droid.dx.dex.code.LocalList.Entry found = null;
            ...
            if (annotate) {
                ...
                annotate(output.getCursor() - mark,
                        "parameter " + parameterName + " "
                                + com.droid.dx.rop.code.RegisterSpec.PREFIX + curParam);
            }
        ...
        for (com.droid.dx.dex.code.LocalList.Entry arg : lastEntryForReg) {
            if (arg == null) {
                continue;
            }

            com.droid.dx.rop.cst.CstString signature = arg.getSignature();
     ...
     */
    private ArrayList<com.droid.dx.dex.code.PositionList.Entry> buildSortedPositions() {
        int sz = (positions == null) ? 0 : positions.size();
        ArrayList<com.droid.dx.dex.code.PositionList.Entry> result = new ArrayList(sz);
        ...
        Collections.sort (result, new Comparator<com.droid.dx.dex.code.PositionList.Entry>() {
            public int compare (com.droid.dx.dex.code.PositionList.Entry a, com.droid.dx.dex.code.PositionList.Entry b) {
     ...
     */
    private ArrayList<com.droid.dx.dex.code.LocalList.Entry> extractMethodArguments() {
        ArrayList<com.droid.dx.dex.code.LocalList.Entry> result
        ...
        for (int i = 0; i < sz; i++) {
            com.droid.dx.dex.code.LocalList.Entry e = locals.get(i);
        ...
        Collections.sort(result, new Comparator<com.droid.dx.dex.code.LocalList.Entry>() {
            public int compare(com.droid.dx.dex.code.LocalList.Entry a, com.droid.dx.dex.code.LocalList.Entry b) {
     ...
     */
    private String entryAnnotationString(com.droid.dx.dex.code.LocalList.Entry e) {
        StringBuilder sb = new StringBuilder();

        sb.append(com.droid.dx.rop.code.RegisterSpec.PREFIX);
        sb.append(e.getRegister());
        sb.append(' ');

        com.droid.dx.rop.cst.CstString name = e.getName();
        if (name == null) {
            sb.append("null");
        } else {
        ...
        com.droid.dx.rop.cst.CstType type = e.getType();
        if (type == null) {
            sb.append("null");
        } else {
        ...
        com.droid.dx.rop.cst.CstString signature = e.getSignature();
     ...
     * @throws IOException
     */
    private void emitLocalRestart(com.droid.dx.dex.code.LocalList.Entry entry)
            throws IOException {
     ...
     * @throws IOException
     */
    private void emitStringIndex(com.droid.dx.rop.cst.CstString string) throws IOException {
     ...
     * @throws IOException
     */
    private void emitTypeIndex(com.droid.dx.rop.cst.CstType type) throws IOException {
     ...
     * @throws IOException
     */
    private void emitLocalStart(com.droid.dx.dex.code.LocalList.Entry entry)
        throws IOException {
     ...
     * @throws IOException
     */
    private void emitLocalStartExtended(com.droid.dx.dex.code.LocalList.Entry entry)
        throws IOException {
     ...
     * @throws IOException
     */
    private void emitLocalEnd(com.droid.dx.dex.code.LocalList.Entry entry)
            throws IOException {
     ...
     * @throws IOException
     */
    private void emitPosition(com.droid.dx.dex.code.PositionList.Entry entry)
            throws IOException {
