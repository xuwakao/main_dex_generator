...
public final class Frame {
    ...
    private final com.droid.dx.cf.code.LocalsArray locals;

    /** {@code non-null;} the stack */
    private final com.droid.dx.cf.code.ExecutionStack stack;
     ...
     */
    private Frame(com.droid.dx.cf.code.LocalsArray locals, com.droid.dx.cf.code.ExecutionStack stack) {
     ...
     */
    private Frame(com.droid.dx.cf.code.LocalsArray locals,
                  com.droid.dx.cf.code.ExecutionStack stack, IntList subroutines) {
        if (locals == null) {
    ...
    public Frame(int maxLocals, int maxStack) {
        this(new OneLocalsArray(maxLocals), new com.droid.dx.cf.code.ExecutionStack(maxStack));
    }
     ...
     */
    public com.droid.dx.cf.code.LocalsArray getLocals() {
        return locals;
    }
     ...
     */
    public com.droid.dx.cf.code.ExecutionStack getStack() {
        return stack;
    }
     ...
     */
    public void initializeWithParameters(com.droid.dx.rop.type.StdTypeList params) {
        int at = 0;
        int sz = params.size();
    ...
    public Frame subFrameForLabel(int startLabel, int subLabel) {
        com.droid.dx.cf.code.LocalsArray subLocals = null;

        if (locals instanceof com.droid.dx.cf.code.LocalsArraySet) {
            subLocals = ((com.droid.dx.cf.code.LocalsArraySet)locals).subArrayForLabel(subLabel);
        }
    ...
    public Frame mergeWith(Frame other) {
        com.droid.dx.cf.code.LocalsArray resultLocals;
        com.droid.dx.cf.code.ExecutionStack resultStack;
     ...
     */
    private static com.droid.dx.cf.code.LocalsArray adjustLocalsForSubroutines(
            com.droid.dx.cf.code.LocalsArray locals, IntList subroutines) {
        if (! (locals instanceof com.droid.dx.cf.code.LocalsArraySet)) {
            // nothing to see here
            return locals;
        }

        com.droid.dx.cf.code.LocalsArraySet laSet = (com.droid.dx.cf.code.LocalsArraySet)locals;
    ...
    public Frame makeExceptionHandlerStartFrame(CstType exceptionClass) {
        com.droid.dx.cf.code.ExecutionStack newStack = getStack().copy();
