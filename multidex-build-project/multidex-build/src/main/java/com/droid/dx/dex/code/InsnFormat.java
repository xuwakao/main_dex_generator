...
public abstract class InsnFormat {
     ...
     */
    public abstract void writeTo(com.droid.dx.util.AnnotatedOutput out, DalvInsn insn);
     ...
     * @return {@code non-null;} the string form
     */
    protected static String regListString(com.droid.dx.rop.code.RegisterSpecList list) {
        int sz = list.size();
     ...
     * @return {@code non-null;} the string form
     */
    protected static String regRangeString(com.droid.dx.rop.code.RegisterSpecList list) {
        int size = list.size();
        ...
        switch (size) {
            ...
            default: {
                com.droid.dx.rop.code.RegisterSpec lastReg = list.get(size - 1);
    ...
    protected static String literalBitsComment(CstLiteralBits value,
        ...
        if (value instanceof com.droid.dx.rop.cst.CstLiteral64) {
            bits = ((com.droid.dx.rop.cst.CstLiteral64) value).getLongBits();
        } else {
    ...
    protected static String cstString(DalvInsn insn) {
        ...
        com.droid.dx.rop.cst.Constant cst = ci.getConstant();

        return cst instanceof com.droid.dx.rop.cst.CstString ? ((com.droid.dx.rop.cst.CstString) cst).toQuoted() : cst.toHuman();
    }
     ...
     */
    protected static boolean isRegListSequential(com.droid.dx.rop.code.RegisterSpecList list) {
        int sz = list.size();
        ...
        for (int i = 0; i < sz; i++) {
            com.droid.dx.rop.code.RegisterSpec one = list.get(i);
            if (one.getReg() != next) {
                return false;
            }
    ...
    protected static int argIndex(DalvInsn insn) {
        int arg = ((com.droid.dx.rop.cst.CstInteger) ((CstInsn) insn).getConstant()).getValue();
     ...
     */
    protected static void write(com.droid.dx.util.AnnotatedOutput out, short c0) {
        out.writeShort(c0);
    }
     ...
     */
    protected static void write(com.droid.dx.util.AnnotatedOutput out, short c0, short c1) {
        out.writeShort(c0);
        out.writeShort(c1);
    }
     ...
     */
    protected static void write(com.droid.dx.util.AnnotatedOutput out, short c0, int c1c2) {
     ...
     */
    protected static void write(com.droid.dx.util.AnnotatedOutput out, short c0, long c1c2c3c4) {
