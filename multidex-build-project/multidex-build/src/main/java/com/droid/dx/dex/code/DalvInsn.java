...
import com.droid.dx.util.TwoColumnOutput;
...
public abstract class DalvInsn {
    ...
    private final com.droid.dx.rop.code.RegisterSpecList registers;
    ...
    public static SimpleInsn makeMove(SourcePosition position,
                                      com.droid.dx.rop.code.RegisterSpec dest, com.droid.dx.rop.code.RegisterSpec src) {
        ...
        return new SimpleInsn(opcode, position,
                              com.droid.dx.rop.code.RegisterSpecList.make(dest, src));
    }
     ...
     * com.droid.dx.rop.code.RegisterSpecList#EMPTY}.</p>
     *
     ...
     */
    public final com.droid.dx.rop.code.RegisterSpecList getRegisters() {
        return registers;
    }
    ...
    public DalvInsn getLowRegVersion() {
        com.droid.dx.rop.code.RegisterSpecList regs =
    ...
    public DalvInsn expandedPrefix(BitSet compatRegs) {
        com.droid.dx.rop.code.RegisterSpecList regs = registers;
        ...
        return new com.droid.dx.dex.code.HighRegisterPrefix(position, regs);
    }
    ...
    public DalvInsn expandedSuffix(BitSet compatRegs) {
        if (hasResult() && !compatRegs.get(0)) {
            com.droid.dx.rop.code.RegisterSpec r = registers.get(0);
     ...
     * @return {@code non-null;} an appropriately-constructed instance
     */
    public DalvInsn withMapper(com.droid.dx.ssa.RegisterMapper mapper) {
     ...
     */
    public abstract void writeTo(com.droid.dx.util.AnnotatedOutput out);
     ...
     * @return {@code non-null;} an appropriately-constructed instance
     */
    public abstract DalvInsn withRegisters(com.droid.dx.rop.code.RegisterSpecList registers);
