...
public final class EncodedArrayItem extends OffsettedItem {
    ...
    public void addContents(com.droid.dx.dex.file.DexFile file) {
        com.droid.dx.dex.file.ValueEncoder.addContents(file, array);
    }
    ...
    protected void place0(com.droid.dx.dex.file.Section addedTo, int offset) {
        ...
        com.droid.dx.dex.file.ValueEncoder encoder = new com.droid.dx.dex.file.ValueEncoder(addedTo.getFile(), out);
    ...
    protected void writeTo0(com.droid.dx.dex.file.DexFile file, AnnotatedOutput out) {
        ...
        if (annotates) {
             ...
             * get emitted.
             */
            com.droid.dx.dex.file.ValueEncoder encoder = new com.droid.dx.dex.file.ValueEncoder(file, out);
