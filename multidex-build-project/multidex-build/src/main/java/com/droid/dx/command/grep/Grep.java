...
package com.droid.dx.command.grep;

import com.droid.dex.ClassDef;
import com.droid.dex.EncodedValueReader;
...
public final class Grep {
    ...
    public Grep(final com.droid.dex.Dex dex, Pattern pattern, final PrintWriter out) {
        this.dex = dex;
        this.out = out;

        stringIds = getStringIds(dex, pattern);

        codeReader.setStringVisitor(new com.droid.dx.io.CodeReader.Visitor() {
    ...
    private Set<Integer> getStringIds(com.droid.dex.Dex dex, Pattern pattern) {
