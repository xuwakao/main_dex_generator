...
import com.droid.dx.io.instructions.DecodedInstruction;
import com.droid.dx.io.instructions.ShortArrayCodeOutput;

final class InstructionTransformer {
    private final com.droid.dx.io.CodeReader reader;
    ...
    public InstructionTransformer() {
        this.reader = new com.droid.dx.io.CodeReader();
    ...
    private class GenericVisitor implements com.droid.dx.io.CodeReader.Visitor {
        public void visit(DecodedInstruction[] all, DecodedInstruction one) {
            mappedInstructions[mappedAt++] = one;
        }
    }

    private class StringVisitor implements com.droid.dx.io.CodeReader.Visitor {
        public void visit(DecodedInstruction[] all, DecodedInstruction one) {
    ...
    private class FieldVisitor implements com.droid.dx.io.CodeReader.Visitor {
        public void visit(DecodedInstruction[] all, DecodedInstruction one) {
    ...
    private class TypeVisitor implements com.droid.dx.io.CodeReader.Visitor {
        public void visit(DecodedInstruction[] all, DecodedInstruction one) {
    ...
    private class MethodVisitor implements com.droid.dx.io.CodeReader.Visitor {
        public void visit(DecodedInstruction[] all, DecodedInstruction one) {
