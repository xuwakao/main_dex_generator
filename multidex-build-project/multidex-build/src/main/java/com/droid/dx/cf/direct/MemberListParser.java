...
abstract /*package*/ class MemberListParser {
     ...
     */
    public final void setObserver(com.droid.dx.cf.iface.ParseObserver observer) {
     ...
     */
    protected abstract com.droid.dx.cf.iface.Member set(int n, int accessFlags, com.droid.dx.rop.cst.CstNat nat,
    ...
    private void parse() {
        ...
        for (int i = 0; i < count; i++) {
            try {
                ...
                com.droid.dx.rop.cst.CstString desc = (com.droid.dx.rop.cst.CstString) pool.get(descIdx);
                ...
                com.droid.dx.rop.cst.CstNat nat = new com.droid.dx.rop.cst.CstNat(name, desc);
                com.droid.dx.cf.iface.Member member = set(i, accessFlags, nat, attributes);
