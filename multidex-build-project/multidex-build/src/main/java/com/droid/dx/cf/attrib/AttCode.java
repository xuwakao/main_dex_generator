...
public final class AttCode extends BaseAttribute {
    ...
    private final com.droid.dx.cf.iface.AttributeList attributes;
    ...
    public AttCode(int maxStack, int maxLocals, BytecodeArray code,
                   ByteCatchList catches, com.droid.dx.cf.iface.AttributeList attributes) {
        ...
        try {
            if (catches.isMutable()) {
                throw new com.droid.dx.util.MutabilityException("catches.isMutable()");
            }
        ...
        try {
            if (attributes.isMutable()) {
                throw new com.droid.dx.util.MutabilityException("attributes.isMutable()");
            }
        } catch (NullPointerException ex) {
            // Translate the exception.
     ...
     */
    public com.droid.dx.cf.iface.AttributeList getAttributes() {
        return attributes;
    }
}
