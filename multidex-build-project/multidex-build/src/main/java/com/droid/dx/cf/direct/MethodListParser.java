...
final /*package*/ class MethodListParser extends MemberListParser {
    ...
    final private com.droid.dx.cf.iface.StdMethodList methods;
     ...
     */
    public MethodListParser(DirectClassFile cf, com.droid.dx.rop.cst.CstType definer,
            int offset, AttributeFactory attributeFactory) {
        super(cf, definer, offset, attributeFactory);
        methods = new com.droid.dx.cf.iface.StdMethodList(getCount());
    }
     ...
     */
    public com.droid.dx.cf.iface.StdMethodList getList() {
        parseIfNecessary();
        return methods;
    }
    ...
    protected String humanAccessFlags(int accessFlags) {
        return com.droid.dx.rop.code.AccessFlags.methodString(accessFlags);
    }
    ...
    /** {@inheritDoc} */
    @Override
    protected com.droid.dx.cf.iface.Member set(int n, int accessFlags, com.droid.dx.rop.cst.CstNat nat,
                                               com.droid.dx.cf.iface.AttributeList attributes) {
        com.droid.dx.cf.iface.StdMethod meth =
            new com.droid.dx.cf.iface.StdMethod(getDefiner(), accessFlags, nat, attributes);
