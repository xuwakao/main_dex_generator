 ...
 */
public final class Annotation extends com.droid.dx.util.MutabilityControl
        implements Comparable<Annotation>, ToHuman {
    /** {@code non-null;} type of the annotation */
    private final com.droid.dx.rop.cst.CstType type;

    /** {@code non-null;} the visibility of the annotation */
    private final AnnotationVisibility visibility;

    /** {@code non-null;} map from names to {@link NameValuePair} instances */
    private final TreeMap<com.droid.dx.rop.cst.CstString, NameValuePair> elements;
     ...
     */
    public Annotation(com.droid.dx.rop.cst.CstType type, AnnotationVisibility visibility) {
        if (type == null) {
        ...
        this.elements = new TreeMap<com.droid.dx.rop.cst.CstString, NameValuePair>();
    }
     ...
     */
    public com.droid.dx.rop.cst.CstType getType() {
        return type;
    }
