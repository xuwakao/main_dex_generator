...
public final class LocalVariableList extends FixedSizeList {
    ...
    public static LocalVariableList mergeDescriptorsAndSignatures(
        ...
        for (int i = 0; i < descriptorSize; i++) {
            ...
            if (signatureItem != null) {
                com.droid.dx.rop.cst.CstString signature = signatureItem.getSignature();
     ...
     */
    public void set(int n, int startPc, int length, com.droid.dx.rop.cst.CstString name,
                    com.droid.dx.rop.cst.CstString descriptor, com.droid.dx.rop.cst.CstString signature, int index) {
    ...
    public static class Item {
        ...
        private final com.droid.dx.rop.cst.CstString descriptor;

        /** {@code null-ok;} the variable's type signature */
        private final com.droid.dx.rop.cst.CstString signature;
         ...
         * @param index {@code >= 0;} the variable's local index
         */
        public Item(int startPc, int length, com.droid.dx.rop.cst.CstString name,
                    com.droid.dx.rop.cst.CstString descriptor, com.droid.dx.rop.cst.CstString signature, int index) {
            if (startPc < 0) {
         ...
         */
        public com.droid.dx.rop.cst.CstString getDescriptor() {
            return descriptor;
        }
         ...
         * @return {@code null-ok;} the variable's type descriptor
         */
        public com.droid.dx.rop.code.LocalItem getLocalItem() {
            return com.droid.dx.rop.code.LocalItem.make(name, signature);
        }
         ...
         */
        private com.droid.dx.rop.cst.CstString getSignature() {
            return signature;
        }
         ...
         */
        public Item withSignature(com.droid.dx.rop.cst.CstString newSignature) {
