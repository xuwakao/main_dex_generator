...
public abstract class Insn implements ToHuman {
    ...
    private final com.droid.dx.rop.code.SourcePosition position;
     ...
     */
    public Insn(Rop opcode, com.droid.dx.rop.code.SourcePosition position, RegisterSpec result,
     ...
     */
    public final com.droid.dx.rop.code.SourcePosition getPosition() {
        return position;
    }
     ...
     * com.droid.dx.rop.type.StdTypeList#EMPTY} if this instruction has no handlers,
     ...
     */
    public abstract com.droid.dx.rop.type.TypeList getCatches();
     ...
     */
    public abstract Insn withAddedCatch(com.droid.dx.rop.type.Type type);
    ...
    public boolean contentEquals(Insn b) {
        return opcode == b.getOpcode()
                ...
                && com.droid.dx.rop.type.StdTypeList.equalContents(getCatches(), b.getCatches());
    }
    ...
    public static interface Visitor {
        /**
         * Visits a {@link com.droid.dx.rop.code.PlainInsn}.
         *
