...
public class MoveParamCombiner {
    ...
    private void run() {
        ...
        final HashSet<com.droid.dx.ssa.SsaInsn> deletedInsns = new HashSet();
        ...
        ssaMeth.forEachInsn(new com.droid.dx.ssa.SsaInsn.Visitor() {
            ...
            public void visitNonMoveInsn (com.droid.dx.ssa.NormalSsaInsn insn) {
                ...
                if (paramSpecs[param] == null) {
                    ...
                    com.droid.dx.rop.code.LocalItem localA = specA.getLocalItem();
                    com.droid.dx.rop.code.LocalItem localB = specB.getLocalItem();
     ...
     */
    private int getParamIndex(com.droid.dx.ssa.NormalSsaInsn insn) {
