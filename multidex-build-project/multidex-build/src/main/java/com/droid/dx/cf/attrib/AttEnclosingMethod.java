...
public final class AttEnclosingMethod extends BaseAttribute {
    ...
    private final com.droid.dx.rop.cst.CstNat method;
     ...
     * method, if any
     */
    public AttEnclosingMethod(CstType type, com.droid.dx.rop.cst.CstNat method) {
     ...
     * method, if any
     */
    public com.droid.dx.rop.cst.CstNat getMethod() {
        return method;
    }
}
