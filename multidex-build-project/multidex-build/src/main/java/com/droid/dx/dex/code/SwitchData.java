...
public final class SwitchData extends VariableSizeInsn {
    ...
    public void writeTo(AnnotatedOutput out) {
        ...
        if (packed) {
            ...
            out.writeShort(com.droid.dx.io.Opcodes.PACKED_SWITCH_PAYLOAD);
            ...
            out.writeShort(com.droid.dx.io.Opcodes.SPARSE_SWITCH_PAYLOAD);
            out.writeShort(sz);
    ...
    /** {@inheritDoc} */
    @Override
    public com.droid.dx.dex.code.DalvInsn withRegisters(RegisterSpecList registers) {
