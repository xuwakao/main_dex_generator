...
public final class ProtoIdsSection extends UniformItemSection {
    /**
     * {@code non-null;} map from method prototypes to {@link com.droid.dx.dex.file.ProtoIdItem} instances
     */
    private final TreeMap<Prototype, com.droid.dx.dex.file.ProtoIdItem> protoIds;
    ...
    public ProtoIdsSection(DexFile file) {
        ...
        protoIds = new TreeMap<Prototype, com.droid.dx.dex.file.ProtoIdItem>();
    }

    /** {@inheritDoc} */
    @Override
    public Collection<? extends com.droid.dx.dex.file.Item> items() {
        return protoIds.values();
    }

    /** {@inheritDoc} */
    @Override
    public com.droid.dx.dex.file.IndexedItem get(Constant cst) {
     ...
     */
    public synchronized com.droid.dx.dex.file.ProtoIdItem intern(Prototype prototype) {
        if (prototype == null) {
        ...
        com.droid.dx.dex.file.ProtoIdItem result = protoIds.get(prototype);

        if (result == null) {
            result = new com.droid.dx.dex.file.ProtoIdItem(prototype);
    ...
    public int indexOf(Prototype prototype) {
        ...
        com.droid.dx.dex.file.ProtoIdItem item = protoIds.get(prototype);
    ...
    protected void orderItems() {
        ...
        for (Object i : items()) {
            ((com.droid.dx.dex.file.ProtoIdItem) i).setIndex(idx);
            idx++;
        }
    }
}
