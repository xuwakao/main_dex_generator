...
package com.droid.dx.rop.type;

import com.droid.dx.util.FixedSizeList;
...
public final class StdTypeList
    ...
    public static final StdTypeList INT = StdTypeList.make(com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [long]} */
    public static final StdTypeList LONG = StdTypeList.make(com.droid.dx.rop.type.Type.LONG);

    /** {@code non-null;} the list {@code [float]} */
    public static final StdTypeList FLOAT = StdTypeList.make(com.droid.dx.rop.type.Type.FLOAT);

    /** {@code non-null;} the list {@code [double]} */
    public static final StdTypeList DOUBLE = StdTypeList.make(com.droid.dx.rop.type.Type.DOUBLE);

    /** {@code non-null;} the list {@code [Object]} */
    public static final StdTypeList OBJECT = StdTypeList.make(com.droid.dx.rop.type.Type.OBJECT);

    /** {@code non-null;} the list {@code [ReturnAddress]} */
    public static final StdTypeList RETURN_ADDRESS
            = StdTypeList.make(com.droid.dx.rop.type.Type.RETURN_ADDRESS);

    /** {@code non-null;} the list {@code [Throwable]} */
    public static final StdTypeList THROWABLE =
        StdTypeList.make(com.droid.dx.rop.type.Type.THROWABLE);

    /** {@code non-null;} the list {@code [int, int]} */
    public static final StdTypeList INT_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.INT, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [long, long]} */
    public static final StdTypeList LONG_LONG =
        StdTypeList.make(com.droid.dx.rop.type.Type.LONG, com.droid.dx.rop.type.Type.LONG);

    /** {@code non-null;} the list {@code [float, float]} */
    public static final StdTypeList FLOAT_FLOAT =
        StdTypeList.make(com.droid.dx.rop.type.Type.FLOAT, com.droid.dx.rop.type.Type.FLOAT);

    /** {@code non-null;} the list {@code [double, double]} */
    public static final StdTypeList DOUBLE_DOUBLE =
        StdTypeList.make(com.droid.dx.rop.type.Type.DOUBLE, com.droid.dx.rop.type.Type.DOUBLE);

    /** {@code non-null;} the list {@code [Object, Object]} */
    public static final StdTypeList OBJECT_OBJECT =
        StdTypeList.make(com.droid.dx.rop.type.Type.OBJECT, com.droid.dx.rop.type.Type.OBJECT);

    /** {@code non-null;} the list {@code [int, Object]} */
    public static final StdTypeList INT_OBJECT =
        StdTypeList.make(com.droid.dx.rop.type.Type.INT, com.droid.dx.rop.type.Type.OBJECT);

    /** {@code non-null;} the list {@code [long, Object]} */
    public static final StdTypeList LONG_OBJECT =
        StdTypeList.make(com.droid.dx.rop.type.Type.LONG, com.droid.dx.rop.type.Type.OBJECT);

    /** {@code non-null;} the list {@code [float, Object]} */
    public static final StdTypeList FLOAT_OBJECT =
        StdTypeList.make(com.droid.dx.rop.type.Type.FLOAT, com.droid.dx.rop.type.Type.OBJECT);

    /** {@code non-null;} the list {@code [double, Object]} */
    public static final StdTypeList DOUBLE_OBJECT =
        StdTypeList.make(com.droid.dx.rop.type.Type.DOUBLE, com.droid.dx.rop.type.Type.OBJECT);

    /** {@code non-null;} the list {@code [long, int]} */
    public static final StdTypeList LONG_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.LONG, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [int[], int]} */
    public static final StdTypeList INTARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.INT_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [long[], int]} */
    public static final StdTypeList LONGARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.LONG_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [float[], int]} */
    public static final StdTypeList FLOATARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.FLOAT_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [double[], int]} */
    public static final StdTypeList DOUBLEARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.DOUBLE_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [Object[], int]} */
    public static final StdTypeList OBJECTARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.OBJECT_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [boolean[], int]} */
    public static final StdTypeList BOOLEANARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.BOOLEAN_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [byte[], int]} */
    public static final StdTypeList BYTEARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.BYTE_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [char[], int]} */
    public static final StdTypeList CHARARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.CHAR_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [short[], int]} */
    public static final StdTypeList SHORTARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.SHORT_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [int, int[], int]} */
    public static final StdTypeList INT_INTARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.INT, com.droid.dx.rop.type.Type.INT_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [long, long[], int]} */
    public static final StdTypeList LONG_LONGARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.LONG, com.droid.dx.rop.type.Type.LONG_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [float, float[], int]} */
    public static final StdTypeList FLOAT_FLOATARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.FLOAT, com.droid.dx.rop.type.Type.FLOAT_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [double, double[], int]} */
    public static final StdTypeList DOUBLE_DOUBLEARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.DOUBLE, com.droid.dx.rop.type.Type.DOUBLE_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [Object, Object[], int]} */
    public static final StdTypeList OBJECT_OBJECTARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.OBJECT, com.droid.dx.rop.type.Type.OBJECT_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [int, boolean[], int]} */
    public static final StdTypeList INT_BOOLEANARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.INT, com.droid.dx.rop.type.Type.BOOLEAN_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [int, byte[], int]} */
    public static final StdTypeList INT_BYTEARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.INT, com.droid.dx.rop.type.Type.BYTE_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [int, char[], int]} */
    public static final StdTypeList INT_CHARARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.INT, com.droid.dx.rop.type.Type.CHAR_ARRAY, com.droid.dx.rop.type.Type.INT);

    /** {@code non-null;} the list {@code [int, short[], int]} */
    public static final StdTypeList INT_SHORTARR_INT =
        StdTypeList.make(com.droid.dx.rop.type.Type.INT, com.droid.dx.rop.type.Type.SHORT_ARRAY, com.droid.dx.rop.type.Type.INT);
     ...
     */
    public static StdTypeList make(com.droid.dx.rop.type.Type type) {
     ...
     * @return {@code non-null;} an appropriately-constructed instance
     */
    public static StdTypeList make(com.droid.dx.rop.type.Type type0, com.droid.dx.rop.type.Type type1) {
     ...
     * @return {@code non-null;} an appropriately-constructed instance
     */
    public static StdTypeList make(com.droid.dx.rop.type.Type type0, com.droid.dx.rop.type.Type type1, com.droid.dx.rop.type.Type type2) {
     ...
     */
    public static StdTypeList make(com.droid.dx.rop.type.Type type0, com.droid.dx.rop.type.Type type1, com.droid.dx.rop.type.Type type2,
                                   com.droid.dx.rop.type.Type type3) {
    ...
    /** {@inheritDoc} */
    public com.droid.dx.rop.type.Type getType(int n) {
        return get(n);
    }
    ...
    /** {@inheritDoc} */
    public TypeList withAddedType(com.droid.dx.rop.type.Type type) {
        int sz = size();
     ...
     */
    public com.droid.dx.rop.type.Type get(int n) {
        return (com.droid.dx.rop.type.Type) get0(n);
    }
     ...
     */
    public void set(int n, com.droid.dx.rop.type.Type type) {
        set0(n, type);
    }
     ...
     * @return {@code non-null;} an appropriately-constructed instance
     */
    public StdTypeList withFirst(com.droid.dx.rop.type.Type type) {
        int sz = size();
        StdTypeList result = new StdTypeList(sz + 1);
