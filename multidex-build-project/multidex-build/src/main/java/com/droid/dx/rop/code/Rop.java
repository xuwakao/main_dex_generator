...
public final class Rop {
    ...
    /**
     * {@code non-null;} result type of this operation; {@link com.droid.dx.rop.type.Type#VOID} for
     * no-result operations
     */
    private final com.droid.dx.rop.type.Type result;

    /** {@code non-null;} types of all the sources of this operation */
    private final com.droid.dx.rop.type.TypeList sources;

    /** {@code non-null;} list of possible types thrown by this operation */
    private final com.droid.dx.rop.type.TypeList exceptions;
     ...
     * com.droid.dx.rop.type.Type#VOID} for no-result operations
     ...
     */
    public Rop(int opcode, com.droid.dx.rop.type.Type result, com.droid.dx.rop.type.TypeList sources,
               com.droid.dx.rop.type.TypeList exceptions, int branchingness, boolean isCallLike,
               String nickname) {
        if (result == null) {
     ...
     */
    public Rop(int opcode, com.droid.dx.rop.type.Type result, com.droid.dx.rop.type.TypeList sources,
               com.droid.dx.rop.type.TypeList exceptions, int branchingness, String nickname) {
     ...
     * @param nickname {@code null-ok;} optional nickname (used for debugging)
     */
    public Rop(int opcode, com.droid.dx.rop.type.Type result, com.droid.dx.rop.type.TypeList sources, int branchingness,
               String nickname) {
        this(opcode, result, sources, com.droid.dx.rop.type.StdTypeList.EMPTY, branchingness, false,
             nickname);
    }
     ...
     * @param nickname {@code null-ok;} optional nickname (used for debugging)
     */
    public Rop(int opcode, com.droid.dx.rop.type.Type result, com.droid.dx.rop.type.TypeList sources, String nickname) {
        this(opcode, result, sources, com.droid.dx.rop.type.StdTypeList.EMPTY, Rop.BRANCH_NONE,
             false, nickname);
    }
     ...
     * @param nickname {@code null-ok;} optional nickname (used for debugging)
     */
    public Rop(int opcode, com.droid.dx.rop.type.Type result, com.droid.dx.rop.type.TypeList sources, com.droid.dx.rop.type.TypeList exceptions,
               String nickname) {
     ...
     * operation
     */
    public Rop(int opcode, com.droid.dx.rop.type.TypeList sources, com.droid.dx.rop.type.TypeList exceptions) {
        this(opcode, com.droid.dx.rop.type.Type.VOID, sources, exceptions, Rop.BRANCH_THROW, true,
             null);
    }
    ...
    public String toString() {
        ...
        if (result != com.droid.dx.rop.type.Type.VOID) {
            sb.append(" ");
            sb.append(result);
        } else {
            sb.append(" .");
        ...
        if (sz != 0) {
            ...
            for (int i = 0; i < sz; i++) {
                sb.append(' ');
                com.droid.dx.rop.type.Type one = exceptions.getType(i);
                if (one == com.droid.dx.rop.type.Type.THROWABLE) {
                    sb.append("<any>");
                } else {
            ...
            switch (branchingness) {
                ...
                default: sb.append(" " + com.droid.dx.util.Hex.u1(branchingness)); break;
            }
        }
    ...
    /**
     * Gets the result type. A return value of {@link com.droid.dx.rop.type.Type#VOID}
     * means this operation returns nothing.
     *
     * @return {@code null-ok;} the result spec
     */
    public com.droid.dx.rop.type.Type getResult() {
        return result;
    }
     ...
     */
    public com.droid.dx.rop.type.TypeList getSources() {
        return sources;
    }
     ...
     */
    public com.droid.dx.rop.type.TypeList getExceptions() {
        return exceptions;
    }
