...
import com.droid.dx.cf.attrib.AttAnnotationDefault;
import com.droid.dx.cf.attrib.AttCode;
import com.droid.dx.cf.attrib.AttConstantValue;
import com.droid.dx.cf.attrib.AttEnclosingMethod;
import com.droid.dx.cf.attrib.AttExceptions;
import com.droid.dx.cf.attrib.AttInnerClasses;
import com.droid.dx.cf.attrib.AttLineNumberTable;
import com.droid.dx.cf.attrib.AttLocalVariableTable;
import com.droid.dx.cf.attrib.AttRuntimeInvisibleAnnotations;
import com.droid.dx.cf.attrib.AttRuntimeInvisibleParameterAnnotations;
import com.droid.dx.cf.attrib.AttRuntimeVisibleAnnotations;
import com.droid.dx.cf.attrib.AttRuntimeVisibleParameterAnnotations;
import com.droid.dx.cf.attrib.AttSignature;
import com.droid.dx.cf.attrib.AttSourceFile;
import com.droid.dx.cf.attrib.InnerClassList;
import com.droid.dx.cf.code.ByteCatchList;
import com.droid.dx.cf.code.BytecodeArray;
import com.droid.dx.cf.code.LineNumberList;
import com.droid.dx.cf.iface.Attribute;
import com.droid.dx.cf.iface.ParseException;
import com.droid.dx.cf.iface.StdAttributeList;
...
public class StdAttributeFactory
    ...
    protected Attribute parse0(DirectClassFile cf, int context, String name,
            int offset, int length, com.droid.dx.cf.iface.ParseObserver observer) {
        switch (context) {
            case CTX_CLASS: {
                if (name == com.droid.dx.cf.attrib.AttDeprecated.ATTRIBUTE_NAME) {
                ...
                if (name == com.droid.dx.cf.attrib.AttSynthetic.ATTRIBUTE_NAME) {
            ...
            case CTX_CODE: {
                ...
                if (name == com.droid.dx.cf.attrib.AttLocalVariableTypeTable.ATTRIBUTE_NAME) {
    ...
    private Attribute annotationDefault(DirectClassFile cf,
        ...
        com.droid.dx.cf.direct.AnnotationParser ap =
            new com.droid.dx.cf.direct.AnnotationParser(cf, offset, length, observer);
    ...
    private Attribute code(DirectClassFile cf, int offset, int length,
        ...
        BytecodeArray code =
            new BytecodeArray(bytes.slice(codeOffset, codeOffset + codeLength),
                              pool);
        if (observer != null) {
            code.forEach(new com.droid.dx.cf.direct.CodeObserver(code.getBytes(), observer));
        }
        ...
        com.droid.dx.cf.direct.AttributeListParser parser =
            new com.droid.dx.cf.direct.AttributeListParser(cf, CTX_CODE, offset, this);
    ...
    private Attribute deprecated(DirectClassFile cf, int offset, int length,
        ...
        return new com.droid.dx.cf.attrib.AttDeprecated();
    }
    ...
    private Attribute enclosingMethod(DirectClassFile cf, int offset,
            int length, com.droid.dx.cf.iface.ParseObserver observer) {
        if (length != 4) {
            throwBadLength(4);
        }
    ...
    private Attribute innerClasses(DirectClassFile cf, int offset, int length,
        ...
        for (int i = 0; i < count; i++) {
            ...
            com.droid.dx.rop.cst.CstString name = (com.droid.dx.rop.cst.CstString) pool.get0Ok(nameIdx);
            ...
            if (observer != null) {
                ...
                observer.parsed(bytes, offset + 6, 2,
                                "  access_flags: " +
                                com.droid.dx.rop.code.AccessFlags.innerClassString(accessFlags));
            }
            offset += 8;
        }
    ...
    private Attribute localVariableTable(DirectClassFile cf, int offset,
        ...
        com.droid.dx.cf.code.LocalVariableList list = parseLocalVariables(
    ...
    private Attribute localVariableTypeTable(DirectClassFile cf, int offset,
        ...
        com.droid.dx.cf.code.LocalVariableList list = parseLocalVariables(
                bytes.slice(offset + 2, offset + length), cf.getConstantPool(),
                observer, count, true);
        return new com.droid.dx.cf.attrib.AttLocalVariableTypeTable(list);
    }
     ...
     */
    private com.droid.dx.cf.code.LocalVariableList parseLocalVariables(ByteArray bytes,
                                                                       ConstantPool pool, com.droid.dx.cf.iface.ParseObserver observer, int count,
                                                                       boolean typeTable) {
        ...
        com.droid.dx.cf.code.LocalVariableList list = new com.droid.dx.cf.code.LocalVariableList(count);
        ...
        try {
            for (int i = 0; i < count; i++) {
                ...
                com.droid.dx.rop.cst.CstString name = (com.droid.dx.rop.cst.CstString) pool.get(nameIdx);
                com.droid.dx.rop.cst.CstString type = (com.droid.dx.rop.cst.CstString) pool.get(typeIdx);
                com.droid.dx.rop.cst.CstString descriptor = null;
                com.droid.dx.rop.cst.CstString signature = null;
    ...
    private Attribute signature(DirectClassFile cf, int offset, int length,
        ...
        ConstantPool pool = cf.getConstantPool();
        int idx = bytes.getUnsignedShort(offset);
        com.droid.dx.rop.cst.CstString cst = (com.droid.dx.rop.cst.CstString) pool.get(idx);
    ...
    private Attribute synthetic(DirectClassFile cf, int offset, int length,
        ...
        return new com.droid.dx.cf.attrib.AttSynthetic();
    }
