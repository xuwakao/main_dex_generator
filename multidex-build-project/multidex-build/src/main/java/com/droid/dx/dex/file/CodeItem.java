...
public final class CodeItem extends OffsettedItem {
    ...
    private final com.droid.dx.rop.cst.CstMethodRef ref;

    /** {@code non-null;} the bytecode instructions and associated data */
    private final com.droid.dx.dex.code.DalvCode code;
     ...
     */
    private final com.droid.dx.rop.type.TypeList throwsList;

    /**
     * {@code null-ok;} the debug info or {@code null} if there is none;
     * set in {@link #addContents}
     */
    private com.droid.dx.dex.file.DebugInfoItem debugInfo;
     ...
     */
    public CodeItem(com.droid.dx.rop.cst.CstMethodRef ref, com.droid.dx.dex.code.DalvCode code, boolean isStatic,
                    com.droid.dx.rop.type.TypeList throwsList) {
        super(ALIGNMENT, -1);
    ...
    public void addContents(DexFile file) {
        ...
        if (code.hasPositions() || code.hasLocals()) {
            debugInfo = new com.droid.dx.dex.file.DebugInfoItem(code, isStatic, ref);
            byteData.add(debugInfo);
        }

        if (code.hasAnyCatches()) {
            for (com.droid.dx.rop.type.Type type : code.getCatchTypes()) {
                typeIds.intern(type);
            }
     ...
     */
    public com.droid.dx.rop.cst.CstMethodRef getRef() {
        return ref;
    }
    ...
    protected void place0(Section addedTo, int offset) {
         ...
         */
        code.assignIndices(new com.droid.dx.dex.code.DalvCode.AssignIndicesCallback() {
    ...
    protected void writeTo0(DexFile file, AnnotatedOutput out) {
        ...
        if (annotates) {
            ...
            if (size != 0) {
                out.annotate(0, "  throws " + com.droid.dx.rop.type.StdTypeList.toHuman(throwsList));
            }
        }
    ...
    private void writeCodes(DexFile file, AnnotatedOutput out) {
        ...
        try {
            ...
            throw com.droid.dex.util.ExceptionWithContext.withContext(ex, "...while writing " +
