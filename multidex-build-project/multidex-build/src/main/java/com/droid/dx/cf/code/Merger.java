...
public final class Merger {
    ...
    public static OneLocalsArray mergeLocals(OneLocalsArray locals1,
        ...
        for (int i = 0; i < sz; i++) {
            com.droid.dx.rop.type.TypeBearer tb1 = locals1.getOrNull(i);
            com.droid.dx.rop.type.TypeBearer tb2 = locals2.getOrNull(i);
            com.droid.dx.rop.type.TypeBearer resultType = mergeType(tb1, tb2);
            if (resultType != tb1) {
                /*
    ...
    public static ExecutionStack mergeStack(ExecutionStack stack1,
        ...
        for (int i = 0; i < sz; i++) {
            com.droid.dx.rop.type.TypeBearer tb1 = stack1.peek(i);
            com.droid.dx.rop.type.TypeBearer tb2 = stack2.peek(i);
            com.droid.dx.rop.type.TypeBearer resultType = mergeType(tb1, tb2);
            if (resultType != tb1) {
                /*
                 * We only need to do anything when the result differs
                ...
                try {
                    ...
                    ex.addContext("...while merging stack[" + com.droid.dx.util.Hex.u2(i) + "]");
                    throw ex;
                }
            }
        }
     ...
     */
    public static com.droid.dx.rop.type.TypeBearer mergeType(com.droid.dx.rop.type.TypeBearer ft1, com.droid.dx.rop.type.TypeBearer ft2) {
        if ((ft1 == null) || ft1.equals(ft2)) {
            return ft1;
        } else if (ft2 == null) {
            return null;
        } else {
            com.droid.dx.rop.type.Type type1 = ft1.getType();
            com.droid.dx.rop.type.Type type2 = ft2.getType();

            if (type1 == type2) {
                return type1;
            } else if (type1.isReference() && type2.isReference()) {
                if (type1 == com.droid.dx.rop.type.Type.KNOWN_NULL) {
                    /*
                     * A known-null merges with any other reference type to
                     * be that reference type.
                     */
                    return type2;
                } else if (type2 == com.droid.dx.rop.type.Type.KNOWN_NULL) {
                    /*
                    ...
                    com.droid.dx.rop.type.TypeBearer componentUnion =
                    ...
                    if (componentUnion == null) {
                         ...
                         */
                        return com.droid.dx.rop.type.Type.OBJECT;
                    }
                    return ((com.droid.dx.rop.type.Type) componentUnion).getArrayType();
                } else {
                    /*
                 ...
                 * the type int.
                 */
                return com.droid.dx.rop.type.Type.INT;
            } else {
                return null;
            }
        }
     ...
     */
    public static boolean isPossiblyAssignableFrom(com.droid.dx.rop.type.TypeBearer supertypeBearer,
                                                   com.droid.dx.rop.type.TypeBearer subtypeBearer) {
        com.droid.dx.rop.type.Type supertype = supertypeBearer.getType();
        com.droid.dx.rop.type.Type subtype = subtypeBearer.getType();
        ...
        if (superBt == com.droid.dx.rop.type.Type.BT_ADDR) {
            supertype = com.droid.dx.rop.type.Type.OBJECT;
            superBt = com.droid.dx.rop.type.Type.BT_OBJECT;
        }

        if (subBt == com.droid.dx.rop.type.Type.BT_ADDR) {
            subtype = com.droid.dx.rop.type.Type.OBJECT;
            subBt = com.droid.dx.rop.type.Type.BT_OBJECT;
        }

        if ((superBt != com.droid.dx.rop.type.Type.BT_OBJECT) || (subBt != com.droid.dx.rop.type.Type.BT_OBJECT)) {
            /*
        ...
        if (supertype == com.droid.dx.rop.type.Type.KNOWN_NULL) {
            /*
             ...
             */
            return false;
        } else if (subtype == com.droid.dx.rop.type.Type.KNOWN_NULL) {
            /*
             * A known-null subtype is in fact assignable to any
             * reference type.
             */
            return true;
        } else if (supertype == com.droid.dx.rop.type.Type.OBJECT) {
            /*
             ...
             */
            return (supertype == com.droid.dx.rop.type.Type.SERIALIZABLE) ||
                (supertype == com.droid.dx.rop.type.Type.CLONEABLE);
        } else {
            /*
