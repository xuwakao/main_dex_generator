 ...
 * an array of {@link com.droid.dx.cf.iface.Method} objects and can be made immutable.
 */
public final class StdMethodList extends FixedSizeList implements MethodList {
    ...
    /** {@inheritDoc} */
    public com.droid.dx.cf.iface.Method get(int n) {
        return (com.droid.dx.cf.iface.Method) get0(n);
    }
     ...
     */
    public void set(int n, com.droid.dx.cf.iface.Method method) {
        set0(n, method);
    }
}
